package com.hurlant.math
{
   ...
   class MontgomeryReduction implements IReduction
   {
      ...
      function MontgomeryReduction(param1:BigInteger)
      {
         super();
         this.m = param1;
         this.var_2070 = param1.invDigit();
         this.var_2069 = this.var_2070 & 32767;
         this.var_2867 = this.var_2070 >> 15;
         this.var_2868 = 131071;
         this.var_2866 = 2 * param1.t;
      }
      ...
      public function convert(param1:BigInteger) : BigInteger
      {
         ...
         if(param1.s < 0 && _loc2_.compareTo(BigInteger.const_174) > 0)
         {
