package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      {
         super();
         this.var_1096 = param2 == null ? "" : param2.url;
         this._type = param1;
         this.var_42 = new Loader();
         this.var_1097 = new LoaderContext();
         this.var_1097.checkPolicyFile = true;
         ...
         {
            this.var_42.load(param2,this.var_1097);
         }
      }
      ...
      {
         this.var_1096 = param1.url;
         var_338 = 0;
         this.var_42.load(param1,this.var_1097);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_338 < var_2960)
            {
               ...
               this.var_42.load(new URLRequest(this.var_1096 + (this.var_1096.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_338),this.var_1097);
               return true;
            }
         }
         return false;
