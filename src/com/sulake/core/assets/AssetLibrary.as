package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1151:String = "AssetLibraryReady";
      
      public static const const_931:String = "AssetLibraryLoaded";
      
      public static const const_1827:String = "AssetLibraryUnloaded";
      
      public static const const_1766:String = "AssetLibraryLoadError";
      
      private static const const_461:String = "name";
      
      private static const const_1008:String = "asset";
      
      private static const const_1010:String = "param";
      
      private static const TYPE:String = "mimeType";
      
      private static const const_1009:String = "library";
      
      private static var var_304:Dictionary;
      
      private static var var_1737:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_503:uint = 0;
      
      private static var var_918:Array = new Array();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         this.var_502 = new Dictionary(false);
         this.var_915 = new Dictionary(false);
         this.var_151 = new Dictionary(false);
         var_918.push(this);
      }
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_600 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_1009);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1008);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_461);
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1010);
                  if(_loc11_.length())
                  {
                     _loc10_.setParamsDesc(_loc11_);
                  }
                  param1.method_1(_loc7_,_loc10_);
               }
               else
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_600 + "!");
               }
               _loc15_++;
            }
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_918.splice(var_918.indexOf(this),1);
            --var_503;
            this.var_502 = null;
            this.var_915 = null;
            this.var_151 = null;
      ...
      {
         if(this.var_600 == param1.url && this.var_916)
         {
            if(!this.var_917 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_599);
            }
            this.var_917 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1151));
         }
         else
         {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in this.var_502)
         {
            _loc2_ = this.var_502[_loc1_];
            _loc2_.assetLoader.dispose();
            delete this.var_502[_loc1_];
         }
         ...
         this.var_916 = false;
         this.var_600 = null;
         dispatchEvent(new Event(AssetLibrary.const_1827));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_915[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_502[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1322,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1164,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1183,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1292,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_502[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_502[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_29:
               ...
               if(decl != null)
               {
                  ...
                  if(this.var_151[struct.assetName] == null)
                  {
                     ++this.var_427;
                     this.var_426.push(struct.assetName);
                  }
                  this.var_151[struct.assetName] = asset;
               }
               else
               {
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_502[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         var _loc2_:IAsset = this.var_151[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      {
         return this.var_151[param1] != null || (this.var_599 != null ? this.var_599[param1] != null : false);
      }
      
      public function method_1(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         var _loc4_:* = this.var_151[param1] == null;
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_1737.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function createAsset(param1:String, param2:AssetTypeDeclaration) : IAsset
      {
         ...
         if(!this.method_1(param1,_loc3_))
         {
            _loc3_.dispose();
            _loc3_ = null;
         }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_600 = _loc2_.url;
         if(this.var_917)
         {
            AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_599);
         }
         this.var_916 = true;
         dispatchEvent(new Event(AssetLibrary.const_931));
         dispatchEvent(new Event(AssetLibrary.const_1151));
         if(this.var_917)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1766));
         this.var_42 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1009);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1008);
            _loc5_ = null;
