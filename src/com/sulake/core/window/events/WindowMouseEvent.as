package com.sulake.core.window.events
{
   ...
   public class WindowMouseEvent extends WindowEvent
   {
      ...
      public static const const_2018:String = "WME_MIDDLE_CLICK";
      
      public static const const_1994:String = "WME_MIDDLE_DOWN";
      
      public static const const_2133:String = "WME_MIDDLE_UP";
      
      public static const const_216:String = "WME_MOVE";
      ...
      public static const const_2090:String = "WME_RIGHT_CLICK";
      
      public static const const_2065:String = "WME_RIGHT_DOWN";
      
      public static const const_2064:String = "WME_RIGHT_UP";
      
      public static const const_1806:String = "WME_ROLL_OUT";
      
      public static const const_1845:String = "WME_ROLL_OVER";
      ...
      public static function allocate(param1:String, param2:IWindow, param3:IWindow, param4:Number, param5:Number, param6:Number, param7:Number, param8:Boolean, param9:Boolean, param10:Boolean, param11:Boolean, param12:int) : WindowMouseEvent
      {
         ...
         _loc13_.var_712 = param3;
         _loc13_.var_479 = false;
         _loc13_.var_711 = POOL;
      ...
      {
         return "WindowMouseEvent { type: " + _type + " cancelable: " + var_486 + " window: " + _window + " localX: " + this.localX + " localY: " + this.localY + " }";
      }
   }
}
