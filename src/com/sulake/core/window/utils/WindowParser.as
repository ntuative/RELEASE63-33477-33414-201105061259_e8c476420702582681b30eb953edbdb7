package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1221:String = "_EXCLUDE";
      
      public static const const_2108:String = "_INCLUDE";
      
      public static const const_2082:String = "_TEMP";
      
      private static const const_1544:String = "layout";
      
      private static const const_1089:String = "window";
      
      private static const const_1091:String = "variables";
      
      private static const const_1090:String = "filters";
      
      private static const const_461:String = "name";
      
      private static const const_1551:String = "style";
      
      private static const const_689:String = "params";
      ...
      private static const const_1548:String = "visible";
      
      private static const const_1545:String = "caption";
      ...
      private static const const_1550:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1549:String = "treshold";
      
      private static const const_1542:String = "children";
      
      private static const const_1543:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1546:String = "height_min";
      
      private static const const_1547:String = "height_max";
      
      private static const const_688:String = "true";
      
      private static const const_174:String = "0";
      
      private static const const_1552:String = "$";
      ...
      private static const const_1539:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1368:Dictionary;
      
      protected var var_1369:Dictionary;
      
      protected var var_1103:Dictionary;
      
      protected var var_1646:Dictionary;
      
      protected var var_2179:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1368,this.var_1369);
         this.var_1103 = new Dictionary();
         this.var_1646 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1103,this.var_1646);
         this.var_2179 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1539,const_50);
         return param1.replace(const_1540,const_50);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1368)
            {
               delete this.var_1368[_loc1_];
            }
            for(_loc1_ in this.var_1369)
            {
               delete this.var_1369[_loc1_];
            }
            for(_loc1_ in this.var_1103)
            {
               delete this.var_1103[_loc1_];
            }
            for(_loc1_ in this.var_1646)
            {
               delete this.var_1646[_loc1_];
            }
            this.var_2179.dispose();
            this.var_2179 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1544)
         {
            _loc8_ = param1.child(const_1091);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1090).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
            ...
            _loc4_ = param1.child(const_1089);
         ...
         if(param1.localName() == const_1089)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1368[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_461,variables,"")));
         style = uint(this.parseAttribute(xml,const_1551,variables,style));
         params = uint(this.parseAttribute(xml,const_689,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1541,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_174));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_174));
         rect.width = Number(this.parseAttribute(xml,name_5,variables,const_174));
         rect.height = Number(this.parseAttribute(xml,name_1,variables,const_174));
         visible = this.parseAttribute(xml,const_1548,variables,visible.toString()) == const_688;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_689).length() > 0)
         {
            list = xml.child(const_689).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_461,variables,"") as String;
               if(this.var_1103[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_461)) + "\"!");
               }
         ...
         caption = unescape(String(this.parseAttribute(xml,const_1545,variables,caption)));
         if(tag != const_50)
         {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1091)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1543,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1546,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1547,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_688;
         blend = Number(this.parseAttribute(xml,const_1326,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1550,variables,window.clipping.toString()) == const_688;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1549,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_1090).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_199)
                     {
                        window.x = rect.x;
                     }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_50;
         var _loc3_:String = this.var_1369[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1221) == -1)
                  {
