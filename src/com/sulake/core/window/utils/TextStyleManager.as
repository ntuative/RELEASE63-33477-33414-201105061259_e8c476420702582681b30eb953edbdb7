package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static const const_1452:String = "/*";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_86[const_227],var_86[ITALIC],var_86[BOLD]];
            var_86.reset();
            var_86[const_227] = _loc5_[0];
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         {
            while(_loc5_.indexOf(const_1452) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1453) + 2,_loc5_.length);
            }
