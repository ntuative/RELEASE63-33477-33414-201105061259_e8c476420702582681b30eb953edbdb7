package com.sulake.core.window.utils
{
   ...
   public class PropertyStruct
   {
      ...
      public function PropertyStruct(param1:String, param2:Object, param3:String, param4:Boolean, param5:Array = null)
      {
         ...
         this.var_3009 = param3 == const_284 || param3 == const_166 || param3 == const_273 || param3 == const_276;
      ...
      public function toXMLString() : String
      {
         ...
         switch(this._type)
         {
            case const_284:
               ...
               _loc1_ = "<var key=\"" + this.var_703 + "\">\r<value>\r<" + this._type + ">\r";
               _loc2_ = 0;
            ...
            case const_276:
               ...
               break;
            case const_145:
               _loc1_ = "<var key=\"" + this.var_703 + "\" value=\"" + "0x" + uint(this.var_193).toString(16) + "\" type=\"" + this._type + "\" />";
               break;
            default:
               _loc1_ = "<var key=\"" + this.var_703 + "\" value=\"" + this.var_193 + "\" type=\"" + this._type + "\" />";
         }
         return _loc1_;
      }
   }
