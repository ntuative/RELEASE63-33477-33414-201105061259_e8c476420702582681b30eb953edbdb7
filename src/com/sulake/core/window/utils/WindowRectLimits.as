package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      {
         this.var_297 = param1;
         if(this.var_297 > int.MIN_VALUE && !this._target.disposed && this._target.height < this.var_297)
         {
      ...
      {
         return this.var_299 == int.MIN_VALUE && this.var_300 == int.MAX_VALUE && this.var_297 == int.MIN_VALUE && this.var_298 == int.MAX_VALUE;
      }
      ...
      public function limit() : void
      {
         if(!this.isEmpty && this._target)
         {
            ...
            if(this._target.height < this.var_297)
            {
               this._target.height = this.var_297;
            }
