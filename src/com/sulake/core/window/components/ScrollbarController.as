package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1382:String = "increment";
      
      private static const const_1381:String = "decrement";
      
      private static const const_1018:String = "slider_track";
      
      private static const const_660:String = "slider_bar";
       
      
      protected var _offset:Number = 0;
      
      protected var var_709:Number = 0.1;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         ...
         {
            this.var_16.removeEventListener(WindowEvent.const_39,this.onScrollableResized);
            this.var_16.removeEventListener(WindowEvent.const_632,this.onScrollableScrolled);
         }
         this.var_16 = param1;
         if(this.var_16 != null && !this.var_16.disposed)
         {
            this.var_16.addEventListener(WindowEvent.const_39,this.onScrollableResized);
            this.var_16.addEventListener(WindowEvent.const_632,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_936 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_1018) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_660) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_660:
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_365)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_709;
                  }
                  else
                  {
                     this.scrollV -= this.var_709;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_42 || param1.type == WindowTouchEvent.const_830)
         {
            if(param2.name == const_1382)
            {
               if(this.var_16)
               {
                  this.var_1173 = true;
            ...
            else if(param2.name == const_1381)
            {
               if(this.var_16)
               {
                  this.var_1173 = true;
            ...
            else if(param2.name == const_1018)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_660).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_936) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_936) as IScrollableWindow;
               if(_loc1_)
               {
