package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1402:String = "_SELECTOR";
      
      private static const const_1403:String = "_CONTENT";
       
      
      protected var var_1094:ITabSelectorWindow;
      
      protected var var_2163:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1094 = findChildByTag(const_1402) as ITabSelectorWindow;
            if(this.var_1094 != null)
            {
               this.var_1094.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2163 = findChildByTag(const_1403) as IWindowContainer;
         }
      ...
      {
         return this.var_1094.numSelectables;
      }
