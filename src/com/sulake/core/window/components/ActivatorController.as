package com.sulake.core.window.components
{
   ...
   public class ActivatorController extends ContainerController
   {
      ...
      {
         if(param2.type == WindowEvent.const_355)
         {
            this.setActiveChild(param1 as IWindow);
         }
         else if(param2.type == WindowEvent.const_1252)
         {
            return true;
         }
      ...
      public function setActiveChild(param1:IWindow) : IWindow
      {
         ...
         var _loc2_:IWindow = this.var_888;
         if(this.var_888 != param1)
         {
            if(this.var_888 != null)
            {
               if(!this.var_888.disposed)
               {
                  this.var_888.deactivate();
               }
            }
            this.var_888 = param1;
