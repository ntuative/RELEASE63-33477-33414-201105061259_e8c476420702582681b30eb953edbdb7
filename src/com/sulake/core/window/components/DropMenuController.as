package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      {
         if(param1 > this.var_274.lenght - 1)
         {
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_189 == null || this.var_189.disposed)
         {
            this.var_189 = context.create(name + "::submenu","",WindowType.const_569,var_76,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
      ...
      override public function populate(param1:Array) : void
      {
         ...
         {
            this.var_274.push(param1[_loc2_]);
            _loc2_++;
         }
         this.var_1038 = true;
         this.closeMenuView();
      ...
      protected function openMenuView() : void
      {
         if(!this.var_1038)
         {
            if(this.open())
            {
               if(this.var_274.length)
               {
                  this.populateMenuItemContainer(this.var_274,this.getSubMenu(),this.subMenuEventProc);
                  this.var_1038 = true;
               }
            }
         }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_1038 = false;
            this.getTitleLabel().text = this.var_677 < this.var_274.length && this.var_677 > -1 ? this.var_274[this.var_677] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_497,var_76,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         param2.activate();
         if(this.var_677 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_677).setStateFlag(WindowState.const_55,true);
         }
      }
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1132:
      ...
      public function open() : Boolean
      {
         ...
         _loc1_.recycle();
         visible = true;
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1724,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function close() : Boolean
      {
         ...
         _loc1_.recycle();
         visible = false;
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1561,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function enumerateSelection() : Array
      {
         ...
         if(!_disposed)
         {
            ...
            {
               _loc1_.push(this.var_274[_loc2_]);
               _loc2_++;
            }
         }
         return _loc1_;
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_274.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_882,this.var_274,PropertyStruct.const_166,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1761);
         }
         return _loc1_;
      }
