package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1333:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_882:Number;
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_891 ? true : null;
         }
      ...
      {
         this.var_882 = param1;
         this._field.scrollH = this.var_882 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_882 * this.maxScrollH,this.var_578 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_841,this._field.antiAliasType,PropertyStruct.const_56,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1228));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1162 ? new PropertyStruct(PropertyDefaults.const_985,this._autoSize,PropertyStruct.const_56,true,PropertyDefaults.const_1167) : PropertyDefaults.const_1794);
         _loc1_.push(new PropertyStruct("border",this._field.border,PropertyStruct.const_38,this._field.border == true));
         _loc1_.push(new PropertyStruct("border_color",this._field.borderColor,PropertyStruct.const_145,this._field.borderColor != 0));
         ...
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1225 ? new PropertyStruct(PropertyDefaults.const_1200,this._field.gridFitType,PropertyStruct.const_56,true,PropertyDefaults.const_1202) : PropertyDefaults.const_1604);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_928) ? new PropertyStruct(PropertyDefaults.const_439,this._field.textColor,PropertyStruct.const_145,true) : PropertyDefaults.const_1207);
         _loc1_.push(this.var_440 != TextStyleManager.const_227 ? new PropertyStruct(PropertyDefaults.const_443,this.var_440,PropertyStruct.const_56,true,PropertyDefaults.const_866) : PropertyDefaults.const_1244);
         _loc1_.push(this.var_40.left != PropertyDefaults.const_836 ? new PropertyStruct(PropertyDefaults.const_261,this.var_40.left,PropertyStruct.const_43,true) : PropertyDefaults.const_500);
         _loc1_.push(this.var_40.top != PropertyDefaults.const_749 ? new PropertyStruct(PropertyDefaults.const_242,this.var_40.top,PropertyStruct.const_43,true) : PropertyDefaults.const_543);
         _loc1_.push(this.var_40.right != PropertyDefaults.const_861 ? new PropertyStruct(PropertyDefaults.const_271,this.var_40.right,PropertyStruct.const_43,true) : PropertyDefaults.const_577);
         _loc1_.push(this.var_40.bottom != PropertyDefaults.const_927 ? new PropertyStruct(PropertyDefaults.const_251,this.var_40.bottom,PropertyStruct.const_43,true) : PropertyDefaults.const_514);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1239 ? new PropertyStruct(PropertyDefaults.const_781,this._field.mouseWheelEnabled,PropertyStruct.const_38,true) : PropertyDefaults.const_1813);
