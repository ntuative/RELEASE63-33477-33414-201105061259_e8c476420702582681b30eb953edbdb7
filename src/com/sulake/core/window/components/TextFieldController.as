package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1644:uint = 500;
      ...
      {
         this.var_1360 = param1 == null ? "" : param1;
      }
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_173,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
         {
            _context.handleError(WindowContext.const_397,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_877,false,PropertyStruct.const_38,true) : PropertyDefaults.const_1816);
         _loc1_.push(this.var_1358 != PropertyDefaults.const_1098 ? new PropertyStruct(PropertyDefaults.const_846,this.var_1358,PropertyStruct.const_38,true) : PropertyDefaults.const_1619);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1097 ? new PropertyStruct(PropertyDefaults.const_953,_field.selectable,PropertyStruct.const_38,true) : PropertyDefaults.const_1754);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1302 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_38,true) : PropertyDefaults.const_1848);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_846:
                  ...
                  break;
               case PropertyDefaults.const_953:
               ...
               case PropertyDefaults.const_877:
                  ...
                  break;
               case PropertyDefaults.const_1301:
