package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1177:IItemListWindow;
      
      private var var_431:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_431)
         {
            this.var_431.removeEventListener(WindowEvent.const_244,this.scrollBarEventProc);
            this.var_431.removeEventListener(WindowEvent.const_206,this.scrollBarEventProc);
            this.var_431 = null;
         }
         if(this.var_1177)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1177)
         {
            this.var_1177 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_431)
         {
            this.var_431 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_431)
            {
               this.var_431.addEventListener(WindowEvent.const_244,this.scrollBarEventProc);
               this.var_431.addEventListener(WindowEvent.const_206,this.scrollBarEventProc);
            }
         }
         return this.var_431;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_206)
         {
            this.hideScrollBar();
         }
      }
