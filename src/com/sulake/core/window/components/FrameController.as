package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1405:String = "_TITLE";
      
      private static const const_1408:String = "_HEADER";
      
      private static const const_1409:String = "_CONTENT";
      
      private static const const_1410:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1476:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1405) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1476 = findChildByTag(const_1408) as IHeaderWindow;
            if(!this.var_1476)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_184 = findChildByTag(const_1409) as IWindowContainer;
            if(!this.var_184)
            {
      ...
      {
         return findChildByTag(const_1410) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1331,_loc2_,false);
      ...
      private function setupScaling() : void
      {
         ...
         var _loc3_:Boolean = testParamFlag(WindowParam.const_274);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_263);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_274,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_274,false);
            }
            if(_loc4_ || _loc2_)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_261,_loc3_.left,PropertyStruct.const_43,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_242,_loc3_.top,PropertyStruct.const_43,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_271,0 - _loc3_.right,PropertyStruct.const_43,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_251,0 - _loc3_.bottom,PropertyStruct.const_43,_loc2_));
         }
         else
         {
            ...
            _loc1_.push(PropertyDefaults.const_514);
         }
         return _loc1_;
      }
