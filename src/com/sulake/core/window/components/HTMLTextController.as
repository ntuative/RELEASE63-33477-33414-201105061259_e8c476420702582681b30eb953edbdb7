package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_912:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_741:String;
      
      private var var_1139:String = null;
      
      private var var_1718:StyleSheet = null;
      ...
      {
         this.var_741 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1139 == param2)
         {
            return;
         }
         param1.var_1139 = param2;
         param1.var_1718 = null;
         if(param1.var_1139 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1139);
            param1.var_1718 = _loc3_;
         }
      }
      ...
      {
         return this.var_741 == LinkTarget.const_30 ? defaultLinkTarget : this.var_741;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_18);
            _field.styleSheet = this.var_1718;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1194)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_741 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_725,this.var_741,PropertyStruct.const_56,true,PropertyDefaults.const_831));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_741 = _loc2_.value as String;
               break;
            }
