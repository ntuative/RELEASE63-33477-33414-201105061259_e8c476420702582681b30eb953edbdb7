   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      public static function processInteractiveWindowEvents(param1:IInteractiveWindow, param2:WindowEvent) : void
      {
         if(param1.toolTipCaption != PropertyDefaults.const_565)
         {
            ...
            else if(param2.type != WindowMouseEvent.const_216)
            {
         ...
         for each(_loc3_ in param2)
         {
            switch(_loc3_.key)
            {
               case PropertyDefaults.const_876:
                  ...
                  break;
               case PropertyDefaults.const_907:
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_565)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_876,param1.toolTipCaption,PropertyStruct.const_56,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1569);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1249)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_907,param1.toolTipDelay,PropertyStruct.const_254,true));
         }
         else
         {
      ...
      {
         this.var_1360 = param1 == null ? "null" : param1;
      }
