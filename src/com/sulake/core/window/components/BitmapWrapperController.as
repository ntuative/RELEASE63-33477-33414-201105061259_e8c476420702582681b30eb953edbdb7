package com.sulake.core.window.components
{
   ...
   public class BitmapWrapperController extends WindowController implements IBitmapWrapperWindow, IBitmapDataContainer
   {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_576 != PropertyDefaults.const_1270)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_961,this.var_576,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1581);
         }
         if(this.var_880 != PropertyDefaults.const_1125)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_744,this.var_880,PropertyStruct.const_56,true));
         }
         else
         {
