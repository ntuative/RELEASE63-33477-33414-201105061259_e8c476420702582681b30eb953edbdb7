package com.sulake.core.window.services
{
   ...
   public class WindowMouseOperator implements IDisposable
   {
      ...
      protected var var_717:Point;
      
      protected var var_1489:uint;
      ...
      public function operate(param1:int, param2:int) : void
      {
         ...
         this.getMousePositionRelativeTo(this._window,this._mouse,this.var_717);
         this._window.offset(this.var_717.x - this._offset.x,this.var_717.y - this._offset.y);
      }
