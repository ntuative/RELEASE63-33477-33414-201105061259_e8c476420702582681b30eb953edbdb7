package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1059:uint = 8;
      
      private static const const_1490:String = "skin";
      
      private static const const_1493:String = "bitmap";
      
      private static const const_1492:String = "fill";
      
      private static const const_1494:String = "text";
      
      private static const const_1491:String = "label";
      
      private static const const_1489:String = "shape";
      ...
      private var var_2777:Dictionary;
      
      private var var_2775:Dictionary;
      
      private var var_2776:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_2777 = new Dictionary();
         TypeCodeTable.fillTables(this.var_2030,this.var_2777);
         this.var_2775 = new Dictionary();
         this.var_2776 = new Dictionary();
         StateCodeTable.fillTables(this.var_2775,this.var_2776);
         this.var_462 = new Dictionary();
         this.var_462[const_1490] = BitmapSkinRenderer;
         this.var_462[const_1493] = BitmapDataRenderer;
         this.var_462[const_1492] = FillSkinRenderer;
         this.var_462[const_1494] = TextSkinRenderer;
         this.var_462[const_1491] = LabelRenderer;
         this.var_462[const_1489] = ShapeSkinRenderer;
         ...
         if(var_343 == null)
         {
            ...
            var_343.push(WindowState.const_87);
            var_343.push(WindowState.const_100);
            var_343.push(WindowState.const_55);
            var_343.push(WindowState.const_86);
            var_343.push(WindowState.const_88);
            var_343.push(WindowState.const_90);
            var_343.push(WindowState.const_104);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2944 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_2030[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_1030[param1] = new Array(const_1059);
         }
         this.var_1030[param1][param2] = param3;
         if(this.var_1029[param1] == null)
         {
            this.var_1029[param1] = new Array(const_1059);
         }
