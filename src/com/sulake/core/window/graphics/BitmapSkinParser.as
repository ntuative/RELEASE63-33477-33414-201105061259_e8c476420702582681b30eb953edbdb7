package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_104:String = "com.sulake.habbo.inventory.badges";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_407 = SkinLayoutEntity.const_645;
                  break;
               case "move":
                  _loc5_.var_407 = SkinLayoutEntity.const_348;
                  break;
               case "strech":
                  _loc5_.var_407 = SkinLayoutEntity.const_486;
                  break;
               case "tiled":
                  _loc5_.var_407 = SkinLayoutEntity.const_332;
                  break;
               case "center":
                  _loc5_.var_407 = SkinLayoutEntity.const_1157;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_405 = SkinLayoutEntity.const_645;
                  break;
               case "move":
                  _loc5_.var_405 = SkinLayoutEntity.const_348;
                  break;
               case "strech":
                  _loc5_.var_405 = SkinLayoutEntity.const_486;
                  break;
               case "tiled":
                  _loc5_.var_405 = SkinLayoutEntity.const_332;
                  break;
               case "center":
                  _loc5_.var_405 = SkinLayoutEntity.const_1157;
            }
         }
