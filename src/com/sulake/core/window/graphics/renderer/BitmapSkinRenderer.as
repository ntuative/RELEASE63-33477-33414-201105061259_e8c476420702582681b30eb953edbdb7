package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      public function BitmapSkinRenderer(param1:String)
      {
         ...
         this.var_886 = new Dictionary(false);
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            {
               _loc2_ = this.var_887[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_887[_loc1_];
            }
            this.var_887 = null;
            for(_loc1_ in this.var_886)
            {
               _loc2_ = this.var_886[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_886[_loc1_];
            }
            this.var_886 = null;
         }
      }
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc17_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc10_.var_407 == SkinLayoutEntity.const_348)
                  {
                     REGION.x += _loc14_;
                  }
                  else if(_loc10_.var_407 == SkinLayoutEntity.const_486)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.var_407 == SkinLayoutEntity.const_332)
                  {
                     _loc12_ = true;
                     REGION.right += _loc14_;
                     if(true)
                  ...
                  if(_loc10_.var_405 == SkinLayoutEntity.const_348)
                  {
                     REGION.y += _loc15_;
                  }
                  else if(_loc10_.var_405 == SkinLayoutEntity.const_486)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.var_405 == SkinLayoutEntity.const_332)
                  {
                     _loc13_ = true;
                     REGION.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.var_405 == SkinLayoutEntity.const_332 || _loc10_.var_407 == SkinLayoutEntity.const_332)
                  {
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:SkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.var_407 == SkinLayoutEntity.const_348)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.var_405 == SkinLayoutEntity.const_348)
               {
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = this.var_887[_loc3_];
         if(_loc4_ == null)
         {
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = this.var_886[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)
