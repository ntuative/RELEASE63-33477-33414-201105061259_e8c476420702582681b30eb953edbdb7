package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1858:uint = 1;
      
      protected static const const_1857:uint = 2;
      
      protected static const const_1859:uint = 4;
      
      protected static const const_1860:uint = 3;
      
      protected static const name_4:uint = 7;
      
      public static const const_1605:int = 5;
      
      public static const LIBRARY_LOADER_FINALIZE:String = "LIBRARY_LOADER_FINALIZE";
      
      public static const const_1324:Boolean = false;
      ...
      protected var var_2951:String = "";
      
      protected var var_2950:String = "";
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1324)
         {
            ...
            while(var_749.length < const_1850 && false)
            {
      ...
      {
         return !!this.var_1093 ? uint(this.var_1350 - this.var_2156) : uint(getTimer() - this.var_2156);
      }
      ...
      {
         if(this.var_1092 && !_disposed)
         {
            this.var_1092 = false;
            if(!this.var_1093 && this.var_240)
            {
               this.var_1350 = -1;
               this.var_2156 = getTimer();
               queue(this);
            }
         }
      }
      ...
      {
         if(!this.var_1093 && !_disposed && this.var_1349 > 0)
         {
            try
            {
               this.var_42.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_240,const_1605 - this.var_1349);
            if(this.var_2952)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(this.var_478 == LibraryLoader.const_1860)
         {
