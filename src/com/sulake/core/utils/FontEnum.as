package com.sulake.core.utils
{
   ...
   public class FontEnum
   {
      ...
      private static const const_678:Map = new Map();
      
      private static const const_375:Map = new Map();
      
      private static var var_1258:Boolean = false;
      ...
      {
         return const_678.getValue(param1) != null;
      }
      ...
      private static function init() : void
      {
         ...
         if(!var_1258)
         {
            ...
            for each(_loc3_ in _loc1_)
            {
               ...
               {
                  const_678.add(_loc3_.fontName,_loc3_);
               }
            }
            var_1258 = true;
         }
