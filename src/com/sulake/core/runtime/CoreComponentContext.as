package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1426:String = "asset-libraries";
      
      private static const const_1423:String = "library";
      
      private static const const_1425:String = "service-libraries";
      
      private static const const_1424:String = "library";
      
      private static const const_1422:String = "component-libraries";
      
      private static const const_1421:String = "library";
      
      private static const const_1427:String = "error_data";
      
      private static const const_1429:String = "error_cat";
      
      private static const const_1428:String = "error_desc";
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1427,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1429,String(param3));
         ErrorReportStorage.setParameter(const_1428,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         try
         {
            node = config.child(const_1426)[0];
            if(node != null)
            {
         ...
         {
            error("Failed to parse asset libraries from config xml!",true,Core.const_343,e);
         }
         try
         {
         ...
         {
            error("Failed to parse interfaces from config xml!",true,Core.const_343,e);
         }
         try
         {
            node = config.child(const_1422)[0];
            if(node != null)
            {
               list = node.child(const_1421);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,_debug);
         ...
         {
            error("Failed to parse components from config xml!",true,Core.const_343,e);
         }
         if(!disposed)
         {
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1690);
         if(!disposed)
         {
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_798)
                  {
                     this.var_798.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_534 - this.var_377.length,this.var_534,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_205 ? 0 : this.var_1489 & 0;
         if(_loc3_ == Core.const_619)
         {
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(priority < CoreComponentContext.const_109)
         {
            ...
            {
               if(this.var_641[priority] < priority)
               {
                  ++this.var_641[priority];
                  skip = true;
               }
            }
            if(!skip)
