package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1158:String = "issue_bundle_open";
      
      public static const const_881:String = "issue_bundle_my";
      
      public static const const_1110:String = "issue_bundle_picked";
      
      public static const const_1705:int = 15000;
       
      
      private var var_65:ModerationManager;
      
      private var var_684:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_684 = new IssueBrowser(this,this.var_65.windowManager,this.var_65.assets);
         this.var_1299 = [];
         this.var_1300 = [];
         this.var_1054 = new Map();
         this.var_2848 = parseInt(this.var_65.configuration.getKey("chf.score.updatefactor","60"));
         this.var_2060 = new Timer(const_1705,0);
         this.var_2060.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_2060.start();
      }
      ...
      public function pickBundle(param1:int, param2:Boolean = false, param3:int = 0) : void
      {
         ...
         this.var_1299 = this.var_1299.concat(_loc4_.getIssueIds());
      }
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         this.var_1300 = this.var_1300.concat(param1);
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(this.var_684 == null || !this.var_684.isOpen())
         {
            this.var_65.soundManager.playSound(HabboSoundTypesEnum.const_1294);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         if(param1.state == IssueMessageData.const_1842)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         ...
         {
            _loc6_ = this.getBundles(const_881);
            _loc7_ = false;
            ...
            _loc9_ = this.var_1300.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2848);
            }
         }
      ...
      {
         var _loc2_:IssueHandler = this.var_1054.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_1054.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         this.var_1054.add(param1,_loc3_);
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_1054.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_384 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.prioritySum > _loc3_.prioritySum))
            {
               _loc3_ = _loc5_;
            }
         }
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_1054.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
