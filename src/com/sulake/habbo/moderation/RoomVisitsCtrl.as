package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_895:Array = [];
      
      private static var var_1680:int = 200;
      ...
      {
         return WindowTracker.const_1631;
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_895.pop() as IWindowContainer;
         }
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1390)
         {
