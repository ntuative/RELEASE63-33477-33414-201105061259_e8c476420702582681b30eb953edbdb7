package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_966:Array = [];
      
      private static var var_1842:int = 1000;
      
      private static var var_967:Array = [];
      ...
      private var var_1841:IMessageComposer;
      ...
      {
         this.var_783 = IWindowContainer(this.var_33.getXmlWindow("chatlog_roomheader"));
         this.var_784 = IWindowContainer(this.var_33.getXmlWindow("chatlog_chatline"));
         this.var_491 = new Timer(1000,1);
         ...
         this.var_33.connection.send(this.var_1841);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_966.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_784.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_966.length < var_1842)
         {
            ...
            param1.width = this.var_784.width;
            param1.height = this.var_784.height;
            var_966.push(param1);
         }
         else
         {
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_967.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_783.clone());
      }
      
      private function storeChatHeaderWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_967.length < var_1843)
         {
            _loc2_ = ITextWindow(param1.findChildByName("room_name_txt"));
            _loc2_.procedure = null;
            param1.width = this.var_783.width;
            param1.height = this.var_783.height;
            var_967.push(param1);
         }
         else
         {
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1470.getValue(param2.chatterName))
            {
               this.var_1470.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1470.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1471)
         {
            this.storeChatLineWindow(_loc1_);
         }
         for each(_loc1_ in this.var_1472)
         {
