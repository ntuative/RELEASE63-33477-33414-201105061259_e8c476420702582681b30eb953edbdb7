package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2153:String = "my_issues";
      
      private const const_2152:String = "open_issues";
      
      private const const_2151:String = "picked_issues";
      
      private const const_2201:String = "closed_issues";
      ...
      private var var_369:IIssueBrowserView;
      
      private var var_1813:IIssueBrowserView;
      
      private var var_1812:IIssueBrowserView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_369.view.width = this.var_259.container.width;
         this.var_369.view.height = this.var_259.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2153:
               ...
               {
                  this.var_1813 = new MyIssuesView(this.issueManager,this,this.var_259.container);
               }
               return this.var_1813;
            case this.const_2152:
               if(this.var_1812 == null)
               {
                  this.var_1812 = new OpenIssuesView(this.issueManager,this,this.var_259.container);
               }
               return this.var_1812;
            case this.const_2151:
               if(this.var_1814 == null)
               {
                  this.var_1814 = new PickedIssuesView(this.issueManager,this,this.var_259.container);
               }
