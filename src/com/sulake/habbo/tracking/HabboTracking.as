package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1035:uint = 11;
      ...
      private var var_122:IHabboHelp;
      ...
      private var var_442:FramerateTracker = null;
      
      private var var_263:LatencyTracker = null;
      
      private var var_636:LagWarningLogger = null;
      
      private var var_635:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_442 = new FramerateTracker();
         this.var_263 = new LatencyTracker();
         this.var_636 = new LagWarningLogger();
         this.var_635 = new ToolbarClickTracker(this);
         this.var_1480 = new Array(const_1035);
         var _loc4_:int = 0;
         while(_loc4_ < const_1035)
         {
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1743,new Date().getTime().toString());
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1694,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_720,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1318,String(0));
         }
         ...
         if(!disposed)
         {
            ...
            if(this.var_203)
            {
               if(!this.var_203.disposed)
               {
                  ...
                  Component(this.var_203).events.removeEventListener(HabboFriendListTrackingEvent.const_378,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_122)
            {
               if(!this.var_122.disposed)
               {
                  this.var_122.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_122.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_122.release(new IIDHabboHelp());
               this.var_122 = null;
            }
            if(this._toolbar)
            {
            ...
            if(this._roomEngine)
            {
               if(!this._roomEngine.disposed)
               {
                  ...
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_315,this.onRoomAction);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_183)
         {
            if(this.var_263 != null)
            {
               this.var_263.configuration = this.var_183;
            }
            if(this.var_264 != null)
            {
               this.var_264.configuration = this.var_183;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1576);
            if(this.var_183)
            {
               if(this.var_636 != null)
               {
                  this.var_636.configure(this.var_183);
               }
               if(this.var_442 != null)
               {
                  this.var_442.configure(this.var_183);
               }
               if(this.var_635 != null)
               {
                  this.var_635.configure(this.var_183);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_827,this.onConnectionEvent);
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1700);
         }
         else if(param1.type == HabboHotelViewEvent.const_74)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1723);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1684);
               break;
            case HabboCommunicationEvent.const_827:
               this.trackLoginStep(HabboLoginTrackingStep.const_1771,String(this._communication.port));
               break;
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1095);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1095,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_203).events.addEventListener(HabboFriendListTrackingEvent.const_378,this.onFriendlistTrackingEvent);
      }
      ...
      {
         this.var_122 = param2 as IHabboHelp;
         this.var_122.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_122.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2519)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1661);
            this.var_2519 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.privateRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1318,String(_loc2_.guestRoomId));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_315,this.onRoomAction);
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_331.events.addEventListener(AdEvent.const_592,this.onRoomAdLoad);
      }
      ...
      {
         if(param1.type == RoomEngineEvent.const_315)
         {
            if(this.var_1869 < 1)
            {
               if(!this.var_316)
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_442)
               {
                  ...
                  this.trackConversionPoint("Performance","fps",String(this.var_442.frameRate),_loc2_);
                  ++this.var_1869;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_635)
         {
            this.var_635.track(param1.iconName);
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_531 > -1 && _loc2_ < this.var_531)
         {
            ++this.var_1868;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1868);
         }
         if(this.var_531 > -1 && _loc2_ - this.var_531 > 15000)
         {
            ++this.var_1867;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1867);
         }
         this.var_531 = _loc2_;
         if(this.var_264 != null)
         {
            this.var_264.update(param1,this.var_531);
         }
         if(this.var_263 != null)
         {
            this.var_263.update(param1,this.var_531);
         }
         if(this.var_442 != null)
         {
            this.var_442.trackUpdate(param1,this,this.var_531);
         }
         if(this.var_636 != null)
         {
            this.var_636.update(this.var_531);
         }
      }
   }
}
