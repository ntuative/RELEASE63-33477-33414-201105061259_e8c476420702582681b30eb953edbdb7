package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_2113:int = 1;
      
      public static const const_1966:int = 16777216;
      ...
      private var var_1816:int = 16777216;
      
      private var var_2980:int = 69069;
      
      private var var_2981:int = 5;
      ...
      {
         var _loc1_:int = this.var_2980 * this.var_1815 + this.var_2981;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1816;
         this.var_1815 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1816 * param2);
      }
   }
}
