package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1640:int = 16777215;
      
      public static const const_1629:int = 13421772;
      
      private static const const_1026:int = 16777215;
      
      private static const const_1027:int = 13421772;
      
      private static const const_1024:int = 10066329;
      
      private static const const_1025:int = 10066329;
      
      public static const const_1620:int = 16777215;
      
      public static const const_1715:int = 13421772;
      
      public static const const_1628:int = 10066329;
      ...
      private var var_772:Rectangle = null;
      
      private var var_522:RoomPlaneBitmapMaskParser = null;
      
      private var var_1619:String = null;
      
      private var _floorType:String = null;
      
      private var var_1620:String = null;
      
      private var var_2460:String = null;
      
      private var var_1183:uint = 16777215;
      
      private var var_2462:int = 255;
      
      private var var_2463:int = 255;
      
      private var var_2461:int = 255;
      
      private var var_1807:Boolean = true;
      
      private var var_1707:int = 0;
      
      private var var_1831:int = -1000;
      
      private const const_2150:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_522 = new RoomPlaneBitmapMaskParser();
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_772 = super.boundingRectangle;
         }
         return new Rectangle(this.var_772.x,this.var_772.y,this.var_772.width,this.var_772.height);
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1257);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            _loc13_ = null;
            if(_loc12_ == RoomPlaneData.const_219)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_356)
            {
               ...
               {
                  _loc13_.color = const_1715;
               }
               else
               {
                  _loc13_.color = const_1628;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1755)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_129,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_356)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_1831 + this.const_2150 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_367.length)
            {
               _loc11_ = this.var_622[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_367[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1807)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2461 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2463 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2462 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1648)
         {
            this.var_1648 = param1.updateId;
            this.var_772 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1426 || _loc3_.y != this.var_2321 || _loc3_.z != this.var_2319 || param1.scale != this.var_2318))
            {
               this.var_1426 = _loc3_.x;
               this.var_2321 = _loc3_.y;
               this.var_2319 = _loc3_.z;
               this.var_2318 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1210);
            if(_loc3_ != this.var_2460)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2460 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_936));
            if(_loc4_ != this.var_1183)
            {
               this.var_1183 = _loc4_;
               this.var_2461 = this.var_1183 & 255;
               this.var_2463 = this.var_1183 >> 8 & 255;
               this.var_2462 = this.var_1183 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1281));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_174 != param1.getUpdateID())
         {
            ...
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_204);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_935));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_815));
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_367;
         if(this.var_367.length == 0)
         {
            _loc6_ = this.var_141;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_367.length > 0;
         var _loc9_:int = 0;
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1707;
      }
      ...
      private function getPlaneBitmap(param1:RoomPlane, param2:String) : BitmapData
      {
         ...
         if(_loc3_ == null)
         {
            ...
            this._assetLibrary.method_1(param2,_loc3_);
         }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_522.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_522.maskCount)
         {
            _loc10_ = this.var_522.getMaskType(_loc8_);
            _loc11_ = this.var_522.getMaskLocation(_loc8_);
            _loc12_ = this.var_522.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_129 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_293)
                              {
