package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureCuboidVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected function initializePlanes() : void
      {
         ...
         var _loc3_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_306);
         var _loc4_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_386);
         var _loc5_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_822);
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:int) : void
      {
         ...
         while(_loc5_ < this.var_141.length)
         {
            ...
            if(_loc8_ == null)
            {
               ...
               this._assetLibrary.method_1(_loc7_,_loc8_);
            }
            ...
            if(_loc10_ != null)
            {
               ...
               if(_loc6_)
               {
                  _loc10_.assetName = _loc7_ + "_" + _loc3_.getInstanceId() + "_" + this.var_1707;
               }
