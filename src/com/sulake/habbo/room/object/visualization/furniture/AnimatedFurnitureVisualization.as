package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      protected function getAnimationId(param1:AnimationStateData) : int
      {
         ...
         if(_loc2_ != const_1134 && this._animationData.hasAnimation(this.var_495,_loc2_))
         {
            return _loc2_;
         }
         return const_1134;
         ...
         if(super.updateModel(param1))
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc4_ = _loc3_.getNumber(RoomObjectVariableEnum.const_765);
                     if(_loc4_ > this.var_1705)
                     {
                        this.var_1705 = _loc4_;
      ...
      protected function resetAllAnimationFrames() : void
      {
         if(this.var_111 != null)
         {
            this.var_111.setLayerCount(this.var_700);
         }
      }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         {
            this.var_495 = param1;
            this.var_700 = this._animationData.include(param1);
      ...
      {
         var _loc2_:int = 0;
         if(!this.var_111.animationOver || this.var_907)
         {
      ...
      protected function updateFramesForAnimation(param1:AnimationStateData, param2:Number) : int
      {
         ...
         var _loc11_:* = null;
         var _loc12_:int = 0;
         if(param1.animationOver && !this.var_907)
         {
            return 0;
         }
         ...
         var _loc7_:* = 1 << this.var_700 - 1;
         var _loc8_:int = this.var_700 - 1;
         while(_loc8_ >= 0)
         {
            _loc9_ = param1.getAnimationPlayed(_loc8_);
            if(!_loc9_ || this.var_907)
            {
               ...
               if(this.var_907 || _loc11_ == null || _loc11_.remainingFrameRepeats >= 0 && _loc13_ <= 0)
               {
                  _loc12_ = 0;
                  if(_loc11_ != null)
                  {
                  ...
                  if(_loc12_ == AnimationFrame.const_1174)
                  {
