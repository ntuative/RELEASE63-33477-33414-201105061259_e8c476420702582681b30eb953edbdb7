package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1834:String = "cone";
      
      public static const const_1614:String = "plane";
      ...
      public function reset() : void
      {
         ...
         this.var_982 = 0;
         this.var_972 = false;
         this.init(0,0,0,this._direction,this.var_2556,this.var_981,this.var_2558,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1213.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_972 = true;
         if(this.var_982 < this.var_1496)
         {
            if(this.age > 1)
            {
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1213.length);
         return this.var_1213[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_982 < this.var_1496)
         {
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_982 < this.var_1496)
         {
            ...
            this.y = (2 - this.var_266) * this.y - (1 - this.var_266) * this.lastY + this.var_1890 * this.var_981 * this.var_981;
         ...
         for each(_loc2_ in this.var_380)
         {
            ...
            _loc2_.y = (2 - this.var_266) * _loc2_.y - (1 - this.var_266) * _loc2_.lastY + this.var_1890 * this.var_981 * this.var_981;
