package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1068:int = 15;
      ...
      {
         var _loc7_:int = 0;
         var _loc3_:Number = this.var_1302[param2];
         var _loc4_:int = this.var_1301[param2];
         var _loc5_:int = this.var_1303[param2];
         var _loc6_:Number = this.var_1304[param2];
         if(param1 == 32)
         {
            _loc7_ = const_1068;
         }
         ...
         this.var_1302[param2] = _loc3_;
         if(int(_loc9_) == 0)
         {
            this.var_1304[param2] = this.getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         this.var_1302.push(Math.random() * _loc2_ * 1.5);
         this.var_1302.push(Math.random() * _loc2_ * 1.5);
         this.var_1301 = new Array();
         this.var_1301.push(1);
         this.var_1301.push(-1);
         this.var_1303 = new Array();
         this.var_1303.push(const_1520);
         this.var_1303.push(const_1519);
         this.var_1304 = new Array();
         this.var_1304.push(this.getRandomAmplitudeFactor());
         this.var_1304.push(this.getRandomAmplitudeFactor());
      }
