package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1868:Number = Math.sqrt(0.5);
       
      
      private var _direction:int;
      
      private var var_2937:Number = NaN;
      
      private var var_2936:int = -1;
      
      private var _alphaMultiplier:Number = 1.0;
      
      private var var_1339:String = null;
      ...
      private var var_2939:Number = 0.0;
      ...
      private var var_2934:Number = 0.0;
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(param4)
         {
            this.var_1629 |= this.updateAnimation(_loc6_);
         }
         else
         {
            _loc7_ = this.updateAnimation(_loc6_) | this.var_1629;
            this.var_1629 = 0;
         }
         if(_loc5_ || _loc7_ != 0)
         {
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:int) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(this.var_700 != spriteCount)
         {
            createSprites(this.var_700);
         }
         if(param2)
         {
      ...
      private function updateSprite(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null && _loc3_ != null)
         {
            ...
            if(_loc5_ != null && _loc5_.asset != null)
            {
               ...
               _loc4_.clickHandling = this.var_2479;
            }
            else
            {
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_480 != _loc3_.getUpdateID() || param1 != var_88 || param2 != this.var_2937)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2936 = _loc3_.getNumber(RoomObjectVariableEnum.const_296);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_313));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            this.var_1339 = this.getAdClickUrl(_loc3_);
            if(this.var_1339 == null || this.var_1339.indexOf("http") != 0)
            {
               this.var_1339 = null;
            }
            this.var_2479 = this.var_1339 != null;
            this.var_2934 = _loc3_.getNumber(RoomObjectVariableEnum.const_796);
      ...
      {
         if(this.var_2938 != param2 || this.var_2939 != param1)
         {
            this.var_1086 = [];
            this.var_1085 = [];
            this.var_864 = [];
            ...
            this.var_2935 = this.getSize(param1);
            this.updateLayerCount(this._data.include(param1) + this.getAdditionalSpriteCount());
         }
      }
      ...
      {
         this.var_700 = param1;
         this.var_1628 = this.var_700 - this.getAdditionalSpriteCount();
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         var _loc5_:int = 0;
         var _loc6_:* = null;
         if(this._data == null || param2 >= FurnitureVisualizationData.const_566.length)
         {
            return "";
         }
         var _loc3_:String = this.var_1086[param2];
         var _loc4_:Boolean = this.var_1085[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            _loc5_ = this.var_2935;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_1628)
            {
               _loc6_ = FurnitureVisualizationData.const_566[param2];
            }
            else
            {
               _loc6_ = "sd";
      ...
      {
         if(this.var_871[param3] != null && !this.var_2110)
         {
      ...
      {
         if(this.var_869[param2] != null)
         {
            return this.var_869[param2];
         }
         if(this._data == null)
         {
      ...
      protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         return Math.ceil(this.var_2934 * (param1 / 2));
      }
