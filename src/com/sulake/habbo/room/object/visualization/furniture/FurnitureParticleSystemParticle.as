package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemParticle
   {
      ...
      public function init(param1:Number, param2:Number, param3:Number, param4:Vector3D, param5:Number, param6:Number, param7:int, param8:Boolean = false, param9:Array = null, param10:Boolean = false) : void
      {
         ...
         this.var_1906 = this._x - this._direction.x * param6;
         this.var_1909 = this.var_165 - this._direction.y * param6;
         this.var_1907 = this.var_166 - this._direction.z * param6;
         this.var_535 = 0;
         this.var_1215 = false;
         this.var_987 = param7;
      ...
      {
         ++this.var_535;
         if(this.var_535 == this.var_987)
         {
            this.ignite();
         }
         if(this.var_1908)
         {
            if(this.var_535 / this.var_987 > this.var_1428)
            {
               this._alphaMultiplier = (this.var_987 - this.var_535) / (this.var_987 * (1 - this.var_1428));
            }
         }
      }
      ...
      {
         return this.var_535 <= this.var_987;
      }
