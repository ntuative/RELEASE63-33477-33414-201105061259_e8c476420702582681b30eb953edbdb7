package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystem
   {
      ...
      private var var_1478:ColorTransform;
      ...
      public function FurnitureParticleSystem(param1:AnimatedFurnitureVisualization)
      {
         ...
         this.var_1478 = new ColorTransform();
      ...
      public function setAnimation(param1:int) : void
      {
         ...
         this.var_97 = this.var_1201[param1];
         this.var_972 = false;
         this.updateCanvas();
      }
      ...
      private function updateCanvas() : void
      {
         ...
         if(this.var_1861 >= 0)
         {
            this.var_262 = this._visualization.getSprite(this.var_1861);
            if(this.var_262 && this.var_262.asset)
            {
               ...
               if(this.var_84 == null)
               {
                  this.var_84 = this.var_262.asset.clone();
                  if(this.var_793.alphaMultiplier != 1)
                  {
                     this.var_633 = new BitmapData(this.var_84.width,this.var_84.height,true,4278190080);
                  }
               }
               this.var_2362 = -this.var_262.offsetX;
               this.var_2363 = -this.var_262.offsetY;
               this.var_262.asset = this.var_84;
            }
            if(this.var_84)
            {
      ...
      public function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         {
            return this.var_97.y * this.var_1200;
         }
         return 0;
      }
      ...
      {
         if(!this.var_97 || !this.var_262)
         {
            return;
         }
         if(this.var_84 && this.var_262.asset != this.var_84)
         {
            this.var_262.asset = this.var_84;
         }
         if(this.var_972)
      ...
      public function updateAnimation() : void
      {
         ...
         var _loc2_:* = 0;
         var _loc8_:int = 0;
         if(!this.var_972 && this.var_97.hasIgnited)
         {
            this.var_972 = true;
         }
         _loc8_ = this.var_1273 * this.var_1200;
         this.var_97.update();
         if(this.var_972)
         {
            if(this.var_97.roomObjectSpriteId >= 0)
            ...
            {
               this.var_84.draw(this.var_633,this.var_1860,this.var_793,BlendMode.NORMAL,null,false);
            }
            for each(_loc11_ in this.var_97.particles)
            {
               _loc2_ = Number(_loc11_.y);
               _loc3_ = this.var_2362 + (_loc11_.x - _loc11_.z) * 10 / 10 * this.var_1200;
               _loc4_ = this.var_2363 - _loc8_ + (_loc2_ + (_loc11_.x + _loc11_.z) / 2) * 10 / 10 * this.var_1200;
               ...
               if(_loc6_)
               {
                  ...
                  if(_loc11_.fade && _loc11_.alphaMultiplier < 1)
                  {
                     ...
                     this.var_1478.alphaMultiplier = _loc11_.alphaMultiplier;
                     this.var_84.draw(_loc7_,this._translationMatrix,this.var_1478,BlendMode.NORMAL,null,false);
                  }
                  else
                  {
