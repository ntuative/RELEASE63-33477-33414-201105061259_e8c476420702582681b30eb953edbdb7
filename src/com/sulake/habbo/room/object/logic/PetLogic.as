package com.sulake.habbo.room.object.logic
{
   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_159,RoomObjectMoveEvent.const_413];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(!this.var_2427)
         {
            ...
            if(param1 is RoomObjectAvatarChatUpdateMessage)
            {
               ...
               this.var_1396 = getTimer() + _loc5_.numberOfWords * 1000;
               return;
            }
         ...
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            ...
            _loc11_ = _loc2_.getString(RoomObjectVariableEnum.const_213);
            _loc2_.setString(RoomObjectVariableEnum.const_213,_loc10_.figure);
            _loc2_.setString(RoomObjectVariableEnum.const_1818,_loc10_.race);
            _loc2_.setNumber(RoomObjectVariableEnum.const_719,this.getPaletteIndex(_loc10_.figure));
            return;
         }
      }
      ...
      private function debugMouseEvent(param1:RoomSpriteMouseEvent) : void
      {
         ...
         if(!param1.altKey && !param1.ctrlKey)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_200,_loc3_ + this.var_948);
         }
         else if(param1.altKey && !param1.ctrlKey)
         {
            ++this.var_1799;
            _loc2_.setNumber(RoomObjectVariableEnum.const_281,this.var_1799);
            _loc2_.setNumber(RoomObjectVariableEnum.const_167,NaN);
         }
         else if(param1.ctrlKey && !param1.altKey)
         {
            ++this.var_1798;
            _loc2_.setNumber(RoomObjectVariableEnum.const_167,this.var_1798);
         }
         else
         {
            this.var_948 += 45;
