package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureJukeboxLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_547,RoomObjectFurnitureActionEvent.const_507,RoomObjectFurnitureActionEvent.const_620,RoomObjectFurnitureActionEvent.const_563,RoomObjectWidgetRequestEvent.const_147];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         {
            object.getModelController().setString(RoomWidgetInfostandExtraParamEnum.const_350,RoomWidgetInfostandExtraParamEnum.const_629);
            ...
            if(_loc4_ != this.var_2620)
            {
               this.var_2620 = _loc4_;
               if(_loc4_ == 1)
               {
