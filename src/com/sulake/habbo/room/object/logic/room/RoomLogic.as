package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1391:uint = 16777215;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_614,RoomObjectMouseEvent.const_159];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_815,1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1122)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1687;
            if(_loc2_ - this.var_1122 >= this.var_1685)
            {
               _loc3_ = this.var_1123;
               _loc4_ = this.var_1688;
               this.var_1122 = 0;
            }
            else
            {
               _loc7_ = this.var_1391 >> 16 & 255;
               _loc8_ = this.var_1391 >> 8 & 255;
               _loc9_ = this.var_1391 & 255;
               _loc10_ = this.var_1123 >> 16 & 255;
               _loc11_ = this.var_1123 >> 8 & 255;
               _loc12_ = this.var_1123 & 255;
               _loc13_ = (_loc2_ - this.var_1122) / this.var_1685;
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_773:
               ...
               break;
            case RoomObjectRoomUpdateMessage.const_694:
               param2.setString(RoomObjectVariableEnum.const_223,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_696:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_499:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_293)
               {
                  _loc5_ = "null";
               }
               this.var_522.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_862:
               _loc4_ = this.var_522.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_522.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1210,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1321:
               param2.setNumber(RoomObjectVariableEnum.const_815,_loc3_);
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1281,int(param1.bgOnly));
         this.var_1391 = this._color;
         this.var_1686 = this.var_1687;
         this.var_1123 = _loc3_;
         this.var_1688 = _loc4_;
         this.var_1122 = getTimer();
         this.var_1685 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_612,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1625,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1630,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1733,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_612,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_188 || _loc12_ == RoomPlaneData.const_356)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
