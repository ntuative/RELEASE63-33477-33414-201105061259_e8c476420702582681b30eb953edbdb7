package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1401:String = "pixelbalance";
      
      private static const const_1398:String = "badges";
      
      private static const const_1400:String = "selectbadge";
      
      private static const const_1394:String = "inventory";
      
      private static const const_1395:String = "selectfurni";
      
      private static const UILINK_CREDITS:String = "credits";
      
      private static const const_1399:String = "friendlist";
      
      private static const const_1396:String = "pet_inventory";
      
      private static const const_1397:String = "go_to_room";
      ...
      private var var_782:IHabboToolbar;
      ...
      private var var_781:ParkBusDialogManager;
      
      private var var_2494:Boolean;
      
      private var var_965:ClubGiftNotification;
      
      private var var_962:ClubEndingNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_963);
         }
         var _loc6_:Map = this.var_963["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_782)
         {
            this.var_782.release(new IIDHabboToolbar());
            this.var_782 = null;
         }
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_963["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
         ...
         this.var_1191.push(_loc8_);
         return this.var_1191.length;
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = this.var_1191.splice(0,1);
      ...
      {
         this.var_782 = IHabboToolbar(param2);
         this.var_782.events.addEventListener(HabboToolbarEvent.const_67,this.onHabboToolbarEvent);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_67)
         {
            ...
            this.var_372 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_963["styles"],this.var_963["view"],this.var_782);
            ...
            this.var_349.events.addEventListener(BadgeImageReadyEvent.const_169,this.onBadgeImage);
            this.var_782.events.addEventListener(HabboToolbarEvent.const_516,this.onToolbarRepositionEvent);
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1469[_loc2_.badgeID] = new AchievementNotification(_loc2_.badgeID,_loc2_.achievementID,_loc2_.level,_loc2_.points,_loc2_.levelRewardPoints,_loc2_.levelRewardPointType,_loc2_.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_349);
      }
      ...
      function onAchievementShareId(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:AchievementNotification = this.var_1469[_loc2_.badgeID] as AchievementNotification;
         delete this.var_1469[_loc2_.badgeID];
         if(_loc3_)
         {
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_349.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1295,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1295,null);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1739,null);
         }
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_505.createAvatarImage(param2,AvatarScaleType.const_53);
         if(_loc7_ != null)
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               if(_loc6_.productType == CatalogPageMessageProductData.const_84)
               {
                  _loc7_ = this.var_349.getFloorItemData(_loc6_.furniClassId);
               }
               else if(_loc6_.productType == CatalogPageMessageProductData.const_65)
               {
                  _loc7_ = this.var_349.getWallItemData(_loc6_.furniClassId);
               }
               ...
               {
                  _loc9_ = this.var_349.getProductData(_loc4_.localizationId);
                  if(_loc9_)
                  {
               ...
               if(_loc8_)
               {
                  this.addItem(_loc8_.value,NotificationType.const_1574,_loc5_);
               }
            }
         }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1237)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1602,null);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1608)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               this.var_962 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,assets,this._windowManager,this._catalog,this._localization);
            }
      ...
      {
         var _loc2_:* = null;
         if(this.var_372.isSpaceAvailable() && this.var_1191.length > 0)
         {
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_781 == null)
         {
            this.var_781 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_781 != null)
         {
            this.var_781.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1152,_loc4_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1152,_loc5_);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_505.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_53);
            if(_loc6_ != null)
            {
      ...
      {
         if(param2.type == WindowEvent.const_172 || param2.type == WindowEvent.const_542)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_965 && this.var_965.visible)
         {
            return;
         }
         this.var_965 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog);
      }
