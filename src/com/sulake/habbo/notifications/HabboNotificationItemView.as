package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_496:int = 70;
      ...
      private static const const_469:Number = 50;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar, param6:HabboNotificationItem)
      {
         ...
         if(_loc8_ != null)
         {
            this.var_2113 = this._window.height - _loc8_.rectangle.bottom;
         }
         else
         {
            this.var_2113 = 15;
         }
         this.var_2112 = this._window.height;
         this.var_872 = 4;
         this._blend = 0;
         this._state = name_3;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_559:
               ...
               _loc2_ = Number(this.var_1341) / Number(this.var_476["time_fade_in"]);
               if(this.var_1341 > int(this.var_476["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1093:
               ...
               if(this.var_1630 > int(this.var_476["time_display"]) && !this.var_2111)
               {
                  this.startFadeOut();
               }
               break;
            case const_1092:
               ...
               _loc3_ = 1 - Number(this.var_1340) / Number(this.var_476["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1340 > int(this.var_476["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_2113;
         if(this._window.height < this.var_2112)
         {
            this._window.height = this.var_2112;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         var _loc3_:int = this._toolbar.orientation == "TOP" ? int(const_469) : 0;
         var _loc4_:int = this._toolbar.orientation == "BOTTOM" ? int(_loc2_.height - const_469) : int(_loc2_.height);
         var _loc5_:int = this._toolbar.orientation == "LEFT" ? int(const_469) : 0;
         var _loc6_:int = this._toolbar.orientation == "RIGHT" ? int(_loc2_.width - const_469) : int(_loc2_.width);
         if(this.var_476["position_horizontal_follow_toolbar"] == "true" && (this._toolbar.orientation != "TOP" && this._toolbar.orientation != "BOTTOM"))
         {
            if(this._toolbar.orientation == "LEFT")
            {
               this._window.x = _loc5_ + const_537;
            }
            else
            {
               this._window.x = _loc6_ - this._window.width - const_537;
            }
         }
         else if(this.var_476["position_horizontal"] == "left")
         {
            this._window.x = _loc5_ + const_537;
         }
         else
         ...
         if(this.var_476["position_vertical_follow_toolbar"] == "true" && (this._toolbar.orientation != "RIGHT" && this._toolbar.orientation != "LEFT"))
         {
            if(this._toolbar.orientation == "TOP")
            {
               this._window.y = _loc3_ + this.var_872;
            }
            else
            {
               this._window.y = _loc4_ - this._window.height - this.var_872;
            }
         }
         else if(this.var_476["position_vertical"] == "top")
         {
            this._window.y = _loc3_ + this.var_872;
         }
         else
