package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_672:String = "FriendBar";
      
      private static const const_671:String = "user_interaction";
      
      private static const const_1456:String = "visit_btn_click";
      
      private static const const_1454:String = "chat_btn_click";
      
      private static const const_1458:String = "find_friends_btn_click";
      ...
      private static const const_1457:String = "FRIENDLIST";
      
      private static const const_1455:String = "MESSENGER";
       
      
      private var var_87:IHabboCommunicationManager;
      
      private var var_320:IHabboFriendList;
      
      private var var_459:IHabboMessenger;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_320)
            {
               this.var_320.release(new IIDHabboFriendList());
               this.var_320 = null;
            }
            if(this.var_459)
            {
               this.var_459.release(new IIDHabboMessenger());
               this.var_459 = null;
            }
            this.var_136 = null;
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_87)
         {
            ...
            this.var_87.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_672,const_671,const_1456));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_459)
         {
            this.var_459.startConversation(param1);
            events.dispatchEvent(new NewMessageEvent(false));
            if(this.var_87)
            {
               this.var_87.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_672,const_671,const_1454));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_87)
         {
            ...
            this.var_87.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_672,const_671,const_1458));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_320)
         {
            if(!this.var_320.disposed)
            {
               if(!this.var_320.isOpen())
               {
                  if(this._friendRequests.length > 0)
                  {
                     this.var_320.openFriendRequests();
                  }
                  else
                  {
                     this.var_320.openFriendList();
                  }
               }
               else
               {
                  _loc1_ = this.var_320.mainWindow;
               ...
               if(this.var_87)
               {
                  this.var_87.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_1047,const_1457,!!this.var_320.isOpen() ? const_1046 : const_1048));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_459)
         {
            if(!this.var_459.disposed)
            {
               this.var_459.toggleMessenger();
               if(this.var_87)
               {
                  this.var_87.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_1047,const_1455,!!this.var_459.isOpen() ? const_1046 : const_1048));
               }
            }
         }
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_136 = !!const_302 ? this.sortByNameAndOnlineStatus(this.var_136) : this.sortByName(this.var_136);
         }
