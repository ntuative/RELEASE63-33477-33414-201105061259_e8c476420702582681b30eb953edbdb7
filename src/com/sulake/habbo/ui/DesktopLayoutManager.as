package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1462:String = "room_view";
      
      private const const_2165:String = "room_widget";
      
      private var var_49:IWindowContainer;
      
      private var var_830:int = 50;
      
      private var var_2993:XML = null;
      ...
      public function addWidgetWindow(param1:String, param2:IWindow) : Boolean
      {
         ...
         {
            if(String(_loc3_[_loc5_]).indexOf(this.const_2165) == 0)
            {
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = this.var_49.getChildByTag(this.const_1462) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = this.var_49.findChildByTag(this.const_1462) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
