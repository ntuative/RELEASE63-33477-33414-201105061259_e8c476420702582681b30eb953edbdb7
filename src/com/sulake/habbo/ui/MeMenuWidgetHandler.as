   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_319,this.onFigureUpdate);
            }
            if(this._inventory && !this._inventory.disposed && this._inventory.events)
            {
               ...
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_930,this.onHabboClubSubscriptionChanged);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_501,this.onHelpTutorialEvent);
         ...
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_319,this.onFigureUpdate);
         }
         ...
         if(this._inventory != null)
         {
            ...
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_930,this.onHabboClubSubscriptionChanged);
         }
         ...
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_501,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1589)
            {
               ...
               this.var_2058 = _loc1_;
               this.var_2059 = _loc2_;
            }
            else
            {
               _loc1_ = this.var_2058;
               _loc2_ = this.var_2059;
            }
         }
         if(this._toolbar != null)
         {
            _loc6_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1254,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null && _loc2_ != null)
            {
               if(_loc1_.height > const_465)
               {
                  ...
                  if(_loc2_.height > const_465 - const_1067)
                  {
                     _loc8_.offset(0,_loc2_.height - const_465 + const_1067);
                  }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_783);
         _loc1_.push(RoomWidgetDanceMessage.const_754);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_879);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_712);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_892);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_957);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_733);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_408);
         _loc1_.push(RoomWidgetStopEffectMessage.const_909);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1765);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1127);
         _loc1_.push(RoomWidgetToolbarMessage.const_964);
         _loc1_.push(RoomWidgetToolbarMessage.const_834);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_418);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1727);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1170);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_887);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_857);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_880);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1562);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_750);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_806);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_878);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_857:
               ...
               break;
            case RoomWidgetWaveMessage.const_783:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_754:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_879:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_712:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_892:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_408:
               ...
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_226,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_733:
               ...
               if(this._inventory != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1140:
                        this._catalog.openCatalogPage(CatalogPageName.const_1722,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1285:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_341);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1837:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_80);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1730:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_957:
            case RoomWidgetStopEffectMessage.const_909:
            ...
            case RoomWidgetNavigateToRoomMessage.const_1127:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_887:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_964:
               ...
               break;
            case RoomWidgetToolbarMessage.const_834:
            ...
            case RoomWidgetAvatarEditorMessage.const_418:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_880:
               ...
               break;
            case RoomWidgetStoreSettingsMessage.const_750:
               this._container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_440,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_806:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_440,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_878:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_523));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_402:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_853));
               break;
            default:
