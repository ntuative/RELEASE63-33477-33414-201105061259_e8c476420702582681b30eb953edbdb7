package com.sulake.habbo.ui
{
   ...
   public class PetPackageFurniWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IPetDataListener, IGetImageListener
   {
      ...
      {
         return [RoomSessionPetPackageEvent.const_600,RoomSessionPetPackageEvent.const_476];
      }
         ...
         if(this._container != null && this._container.events != null && param1 != null)
         {
            switch(param1.type)
            {
               case RoomSessionPetPackageEvent.const_600:
                  ...
                  this.var_1162 = _loc2_.petType;
                  this.var_1760 = _loc2_.breed;
                  this._color = _loc2_.color;
                  _loc4_ = this._container.avatarRenderManager.petDataManager.getPetData(this.var_1162,this);
                  _loc5_ = this.getPetImage();
                  _loc3_ = new RoomWidgetPetPackageUpdateEvent(RoomWidgetPetPackageUpdateEvent.const_586,this.var_196,_loc5_,-1,null);
                  this._container.events.dispatchEvent(_loc3_);
                  break;
               case RoomSessionPetPackageEvent.const_476:
                  _loc2_ = param1 as RoomSessionPetPackageEvent;
                  this.var_196 = _loc2_.objectId;
                  _loc6_ = _loc2_.nameValidationStatus;
                  _loc7_ = _loc2_.nameValidationInfo;
                  _loc3_ = new RoomWidgetPetPackageUpdateEvent(RoomWidgetPetPackageUpdateEvent.const_637,this.var_196,null,_loc6_,_loc7_);
                  this._container.events.dispatchEvent(_loc3_);
            }
         }
      }
      ...
      public function petImageReady(param1:String) : void
      {
         ...
         var _loc3_:RoomWidgetPetPackageUpdateEvent = new RoomWidgetPetPackageUpdateEvent(RoomWidgetPetPackageUpdateEvent.const_399,this.var_196,_loc2_,-1,null);
         this._container.events.dispatchEvent(_loc3_);
      }
      
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         var _loc3_:RoomWidgetPetPackageUpdateEvent = new RoomWidgetPetPackageUpdateEvent(RoomWidgetPetPackageUpdateEvent.const_399,this.var_196,param2,-1,null);
         this._container.events.dispatchEvent(_loc3_);
      }
      ...
      private function getPetImage() : BitmapData
      {
         ...
         if(this.var_1162 < 8)
         {
            ...
            _loc2_ = this._container.avatarRenderManager.createPetImage(this.var_1162,this.var_1760,_loc1_,AvatarScaleType.const_53,this);
            if(_loc2_ != null)
            {
         ...
         {
            _loc3_ = 0;
            _loc4_ = this._container.roomEngine.getPetImage(this.var_1162,this.var_1760,new Vector3d(90),64,this,_loc3_);
            if(_loc4_ != null)
            {
               return _loc4_.data;
            }
