package com.sulake.habbo.ui
{
   ...
   public class FurnitureTeaserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_794,RoomWidgetViralFurniMessage.const_944,RoomWidgetViralFurniMessage.const_189];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_794:
               ...
               break;
            case RoomWidgetViralFurniMessage.const_944:
      ...
      {
         return [RoomSessionViralFurniStatusEvent.const_557,RoomSessionViralFurniStatusEvent.const_578];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionViralFurniStatusEvent.const_557:
               ...
               break;
            case RoomSessionViralFurniStatusEvent.const_578:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;
