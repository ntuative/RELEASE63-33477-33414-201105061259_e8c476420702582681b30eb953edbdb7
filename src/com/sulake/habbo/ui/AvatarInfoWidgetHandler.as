package com.sulake.habbo.ui
{
   ...
   public class AvatarInfoWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_938);
         _loc1_.push(RoomWidgetUserActionMessage.const_842);
         return _loc1_;
      }
      
      public function getProcessedEvents() : Array
      {
         return [RoomSessionUserDataUpdateEvent.const_125];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_938:
               this.dispatchOwnAvatarInfo();
               break;
            case RoomWidgetUserActionMessage.const_842:
