package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_222.events.addEventListener(NowPlayingEvent.const_105,this.onNowPlayingChanged);
            this.var_222.events.addEventListener(SongInfoReceivedEvent.const_99,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            if(this._container.sessionDataManager != null)
            {
               ...
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_169,this.onBadgeImage);
            }
         ...
         if(this._container.sessionDataManager != null)
         {
            ...
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_169,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_589.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_589.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_222 != null)
         {
            this.var_222.events.removeEventListener(NowPlayingEvent.const_105,this.onNowPlayingChanged);
            this.var_222.events.removeEventListener(SongInfoReceivedEvent.const_99,this.onSongInfoReceivedEvent);
            this.var_222 = null;
         }
         this.var_1098 = true;
         this.container = null;
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_946);
         _loc1_.push(RoomWidgetFurniActionMessage.const_929);
         _loc1_.push(RoomWidgetFurniActionMessage.const_979);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_797);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_867);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_898);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1568);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_546)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_388 || param1.type == RoomWidgetUserActionMessage.const_582 || param1.type == RoomWidgetUserActionMessage.const_640)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_336:
               return this.method_7(param1 as RoomWidgetRoomObjectMessage);
            ...
            case RoomWidgetFurniActionMessage.const_250:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_946:
            ...
            case RoomWidgetFurniActionMessage.const_929:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_979:
            ...
            case RoomWidgetUserActionMessage.const_388:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_797:
            ...
            case RoomWidgetGetBadgeDetailsMessage.const_867:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_898:
      ...
      private function method_7(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         var _loc2_:int = 0;
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1290);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  {
                     _loc30_ = this.var_222.getRoomItemPlaylist();
                     if(_loc30_ != null)
                     {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_380) == 0)
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_380.length);
                     _loc26_ = parseInt(_loc31_);
                     _loc29_ = "null";
                  }
                  if(_loc26_ != -1)
                  {
                     _loc32_ = this.var_222.getSongInfo(_loc26_);
                     if(_loc32_ != null)
                     {
            ...
            case RoomObjectCategoryEnum.const_33:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_142)
               {
                  _loc13_ = "null";
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_608)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_580);
               }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_115)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_761);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_775;
                  }
                  if(!_loc35_)
                  {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_589.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_589.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_222 != null)
         {
            ...
            if(_loc2_ != -1)
            {
               _loc5_ = this.var_222.getSongInfo(_loc2_);
               if(_loc5_ != null)
               {
                  _loc3_ = _loc5_.name;
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_381,_loc2_,_loc3_,_loc4_));
         }
      }
