package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_789:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_439 != null)
         {
            ...
            {
               _loc2_ = this.var_439.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_595,RoomWidgetChatSelectAvatarMessage.const_739];
      }
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_45) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1279))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_45) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1279))
                              {
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           {
                              _loc13_ = this.var_439.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_631.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                    ...
                                    default:
                                       ...
                                       if(_loc17_ != null)
                                       {
                                          ...
                                          if(_loc18_ != null)
                                          {
                                             ...
                                             this.var_631.add(_loc16_,_loc12_);
                                          }
                                       }
                                 }
                                 if(_loc13_ != null)
                                 {
                                    ...
                                    {
                                       this.var_439.add(_loc16_,_loc13_);
                                    }
                                 }
                              }
                           }
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1195 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1195);
            }
            if(this.var_789 == null)
            {
               ...
               this.var_528.y = 0;
               this.var_528.z = 0;
               this.var_789 = _loc4_.getScreenPoint(this.var_528);
               this.var_1195 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_528.x = 0;
            this.var_528.y = 0;
            this.var_528.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_528);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_789.x || _loc8_.y != this.var_789.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_789,_loc5_));
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         if(this.var_439)
         {
            _loc2_ = this.var_439.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1194.push(_loc2_);
            }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(_loc7_ != 0)
                  {
                     this.var_631.add(param1,_loc7_);
                  }
               }
            }
         }
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1850.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1850.remove(param1);
         if(_loc3_ != null)
         {
