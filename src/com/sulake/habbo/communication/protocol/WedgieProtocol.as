package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1788:uint = 2;
       
      
      private var var_1405:IProtocolEncoder;
      
      private var var_1129:IProtocolDecoder;
      
      public function WedgieProtocol()
      {
         super();
         this.var_1405 = new WedgieEncoder();
         this.var_1129 = new WedgieDecoder();
      }
      ...
      public function getMessages(param1:ByteArray, param2:Array) : uint
      {
         ...
         while(param1.bytesAvailable)
         {
            ...
            if(_loc5_ == const_1856)
            {
               _loc4_.position = 0;
               _loc6_ = this.var_1129.getID(_loc4_);
