package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_550:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_167.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_153,HabboWindowStyle.const_44,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         {
            dispatchEvent(new Event(const_550));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_139.removeEventListener(SSOTicket.const_383,this.onParsedTicketSuccess);
            this.var_139.removeEventListener(SSOTicket.const_342,this.onParsedTicketFailure);
            this.var_139 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_139 = new SSOTicket(this.var_167.assets,_loc3_,_loc2_,param1);
         this.var_139.addEventListener(SSOTicket.const_383,this.onParsedTicketSuccess);
         this.var_139.addEventListener(SSOTicket.const_342,this.onParsedTicketFailure);
      }
      
      private function onParsedTicketSuccess(param1:Event) : void
      {
         Logger.log("Got ticket: " + this.var_139.ticket);
         Logger.log("Has Facebook: " + this.var_139.isFacebookUser);
         if(this.var_139.isFacebookUser)
         {
            this.var_167.habboConfiguration.setKey("facebook.user","1");
         }
         this.var_167.flashClientUrl = this.var_139.flashClientUrl;
         this.var_167.ssoTicket = this.var_139.ticket;
         this.var_139.removeEventListener(SSOTicket.const_383,this.onParsedTicketSuccess);
         this.var_139.removeEventListener(SSOTicket.const_342,this.onParsedTicketFailure);
         this.var_139 = null;
         dispatchEvent(new Event(const_550));
