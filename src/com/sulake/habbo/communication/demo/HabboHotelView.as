package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      public function HabboHotelView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher, param4:Boolean = true)
      {
         ...
         this.var_752 = param2;
         this._events = param3;
         this.var_838 = param1.getDesktop(0);
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_752.loadAssetFromFile("hotel_view_banner_" + this.var_1157,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
      ...
      public function show() : void
      {
         if(this._window && !this._window.disposed)
         {
            this.var_838.addChildAt(this._window,0);
         }
      }
