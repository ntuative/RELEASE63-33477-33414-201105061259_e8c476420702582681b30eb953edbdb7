package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_2138:int = 6710886;
      ...
      private var var_382:ITabSelectorWindow;
      
      private var _catalog:IHabboCatalog;
      
      private var var_536:IFrameWindow;
      
      private var var_449:Timer;
      
      private var var_2252:Number = 0;
      
      private var var_2599:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1218 = [];
         this.var_1505 = [AvatarEditorFigureCategory.const_809,AvatarEditorFigureCategory.const_51,AvatarEditorFigureCategory.const_265,AvatarEditorFigureCategory.const_955,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_116];
         super();
         ...
         this.var_449 = new Timer(1000);
         this.var_449.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1505;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_449.stop();
            this.var_449.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_449 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1505);
         }
         if(param1.length != this.var_1218.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1218.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2599 = this.canChangeOutfit();
            this.var_449.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_382 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_382.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_382.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1218.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_382.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_382.numSelectables)
               {
                  this.var_382.getSelectableAt(_loc6_).x = this.var_382.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
         }
         this.var_382.setSelected(this.var_382.getSelectableAt(0));
         this.attachImages();
         this.update();
      }
      ...
      private function attachImages() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:Array = this.var_1505;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_45) && (this.var_1915 == AvatarEditorSideCategory.const_116 || this.var_2598))
         {
         ...
         this.setViewToCategory(this.var_347);
      }
      ...
      {
         if(this.var_1915 == AvatarEditorSideCategory.const_116)
         {
            this.var_2598 = false;
            this.setSideContent(AvatarEditorSideCategory.const_728);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_728:
               break;
            case AvatarEditorSideCategory.const_529:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_529);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_347 = param1;
         this.var_382.setSelected(this.var_382.getSelectableByName(param1));
      }
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "save":
                  ...
                  this.var_2252 = new Date().valueOf();
                  this.var_2599 = false;
                  this.var_449.start();
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_536)
         {
            ...
            this.var_536 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_536.procedure = this.stripClubDialogEventProc;
            this.var_536.center();
         }
         else
         {
      ...
      private function canChangeOutfit() : Boolean
      {
         ...
         return _loc1_ - this.var_2252 > 5000;
      }
   }
}
