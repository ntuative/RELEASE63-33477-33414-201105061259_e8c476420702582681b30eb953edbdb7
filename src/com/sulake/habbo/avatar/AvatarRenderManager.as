package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2148:String = "hd-99999-99999";
      ...
      private var var_1761:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_340 = RenderMode.const_1698;
         ...
         this.var_104.add(AvatarType.const_128,_loc4_);
         ...
         this.var_104.add(AvatarType.const_75,_loc4_);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_309.init();
         this.var_757.init();
         _loc2_ = this.var_104.getValue(AvatarType.const_128) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_104.getValue(AvatarType.const_75) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_104.getValue(AvatarType.const_128) as AvatarStructure;
            if(_loc3_ != null)
            {
      ...
      private function checkIfReady() : void
      {
         if(!this.var_916)
         {
            if(this.var_2359 && this.var_2361 && this.var_2360)
            {
      ...
      {
         var _loc5_:AvatarStructure = this.var_104.getValue(AvatarType.const_128) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1761)
         {
            this.var_1761 = new AvatarFigureContainer(this.const_2148);
         }
         this.var_228.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1761,param2);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1770)
         {
            _loc6_ = !this.var_309.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_309.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_104.getValue(AvatarType.const_75) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
      ...
      public function resetPetData() : void
      {
         ...
         var _loc2_:AvatarStructure = this.var_104.getValue(AvatarType.const_75);
      ...
      {
         var _loc3_:AvatarStructure = this.var_104.getValue(AvatarType.const_128) as AvatarStructure;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_75:
               _loc3_ = this.var_104.getValue(AvatarType.const_75) as AvatarStructure;
               break;
            default:
