package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1359:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_1152:AvatarEditorHandler;
      ...
      private var var_922:IFigureData;
      ...
      private var var_1425:IHabboAvatarEditorDataSaver = null;
      ...
      {
         this.var_935 = FigureData.const_83;
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_194)
         {
            ...
            this.var_603["null"] = new FigureData(this);
            this.var_603["null"] = new FigureData(this);
            _loc2_ = this.var_603["null"];
            _loc3_ = this.var_603["null"];
            _loc2_.loadAvatarData(const_1361,FigureData.const_83);
            _loc3_.loadAvatarData(const_1359,FigureData.FEMALE);
            this.var_100 = new Map();
            this.var_504 = new Map();
            this.var_100.add(AvatarEditorFigureCategory.const_809,new BodyModel(this));
            this.var_100.add(AvatarEditorFigureCategory.const_51,new HeadModel(this));
            this.var_100.add(AvatarEditorFigureCategory.const_265,new TorsoModel(this));
            this.var_100.add(AvatarEditorFigureCategory.const_955,new LegsModel(this));
            ...
            this.var_504.add(AvatarEditorSideCategory.const_116,new WardrobeModel(this));
            this.var_504.add(AvatarEditorSideCategory.const_529,new ClubPromoModel(this));
            this.var_194 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var _loc4_:FigureData = this.var_603[param2];
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_922.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_922.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_253 == null)
            {
               this.var_253 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_72,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_253.addChild(this._view.window);
               if(param5)
               {
                  this.var_253.center();
               }
            ...
            this.var_253.visible = !this.var_253.visible;
         }
         this._view.show();
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_809);
         }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_505 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         this.var_922 = this.var_505.getFigureData(AvatarType.const_128);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1152 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_603[this.var_935];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1425 != null)
         {
            ...
            this.var_1425.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1740;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1153 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1360)
                  {
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_505.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_505.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            ...
            for each(_loc6_ in _loc8_.partSets)
            {
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1153 >= _loc6_.clubLevel))
               {
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1153 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_504.getValue(AvatarEditorSideCategory.const_116);
      }
