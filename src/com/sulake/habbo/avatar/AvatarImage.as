package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1413:String = "Default";
      ...
      protected var var_1752:int;
      
      protected var var_287:IActiveActionData;
      
      protected var var_1098:Boolean;
      
      protected var var_849:Array;
      
      protected var _assets:AssetAliasCollection;
      
      protected var var_257:AvatarImageCache;
      
      protected var var_616:AvatarFigureContainer;
      
      protected var var_579:IAvatarDataContainer;
      ...
      protected var var_1357:Boolean = false;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.var_616 = param3;
         this.var_257 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1415,const_1414);
         this.var_339 = new Array();
         this.var_976 = new ActiveActionData(AvatarAction.const_405);
         this.var_976.definition = this._structure.getActionDefinition(const_1413);
         this.resetActions();
      ...
      {
         return this._structure.getPartColor(this.var_616,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1874;
         if(param2 < AvatarDirectionAngle.const_1327)
         {
            param2 = AvatarDirectionAngle.const_317 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_317)
         {
            param2 -= NaN;
         }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_268.length == 1 && this.var_89 == this.var_1752)
         {
            return this.var_89 + this.var_538 + this.var_648 % 4;
         }
      ...
      {
         if(param3 != this.var_2606 || param2 != this.var_2607 || param1 != this.var_2605)
         {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1357 || this.var_45 == null || (this.var_45.width != _loc5_.width || this.var_45.height != _loc5_.height))
         {
            if(this.var_45 != null && !this.var_1357)
            {
               this.var_45.dispose();
            }
         ...
         {
            if(this.var_579.paletteIsGrayscale)
            {
               ...
               this.var_45 = _loc13_;
               this.var_45.paletteMap(this.var_45,this.var_45.rect,new Point(0,0),this.var_579.reds,[],[]);
            }
            else
            {
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_339.push(new ActiveActionData(param1,param2,this.var_648));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_287 = this.var_976;
         this.var_287.definition = this.var_976.definition;
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_538 = "";
         this.var_268 = this._structure.sortActions(this.var_339);
         if(this.var_268 == null)
         {
         ...
         {
            this.var_849 = this._structure.getCanvasOffsets(this.var_268,this._scale,this.var_89);
            ...
            if(this.var_1508 != this.var_538)
            {
               _loc1_ = true;
               this.var_1508 = this.var_538;
            }
         }
         this.var_1484 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_268)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_900 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1874 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_579 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_307 || _loc1_.actionType == AvatarAction.const_245 || _loc1_.actionType == AvatarAction.const_404)
               {
                  this.var_900 = true;
               }
            }
