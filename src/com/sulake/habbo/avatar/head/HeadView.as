   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_38)
         {
            ...
            var_38["null"] = new AvatarEditorGridView(var_66,FigureData.const_195,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_66,FigureData.const_275,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_66,FigureData.const_256,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_66,FigureData.const_253,_windowManager,_assetLibrary);
            var_38["null"] = new AvatarEditorGridView(var_66,FigureData.const_264,_windowManager,_assetLibrary);
         }
         else
         {
