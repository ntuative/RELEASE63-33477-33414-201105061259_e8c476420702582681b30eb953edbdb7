package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1878:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1409:IAvatarImage;
      ...
      private var var_2401:ByteArray;
      
      private var var_2402:ImageData;
      
      private var var_1066:PaletteMap;
      
      private var var_939:Array;
      
      private var var_937:Point;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_257.getKeys();
            for each(_loc3_ in _loc2_)
            {
               _loc1_ = this.var_257.getValue(_loc3_) as AvatarImageBodyPartCache;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function disposeInactiveActions(param1:int = 60000) : void
      {
         ...
         var _loc4_:Array = this.var_257.getKeys();
         for each(_loc5_ in _loc4_)
         {
            _loc3_ = this.var_257.getValue(_loc5_) as AvatarImageBodyPartCache;
            if(_loc3_ != null)
            {
      ...
      public function resetBodyPartCache(param1:IActiveActionData) : void
      {
         var _loc2_:* = null;
         var _loc4_:* = null;
         var _loc3_:Array = this.var_257.getKeys();
         for each(_loc4_ in _loc3_)
         {
            _loc2_ = this.var_257.getValue(_loc4_) as AvatarImageBodyPartCache;
            if(_loc2_ != null)
            {
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_764 == GeometryType.const_1265 && param1 == GeometryType.const_1303 || this.var_764 == GeometryType.const_1303 && param1 == GeometryType.const_1265)
         {
            this.var_764 = param1;
            this.var_84 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         if(this._bodyPartCache == null)
         {
            ...
            this.var_257.add(param1,this._bodyPartCache);
         }
            ...
            if(this.var_364.definition.isAnimation)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     ...
                     if(_loc14_.type == AnimationLayerData.const_970)
                     {
                        if(_loc14_.action != null)
                        {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_581)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1409.getFigure(),_loc5_,this.var_764,_loc3_,_loc6_,_loc7_);
         ...
         if(this.var_429 == null)
         {
            ...
            this.var_429 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_364);
            if(this.var_429 == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:AvatarImageBodyPartCache = this.var_257.getValue(param1) as AvatarImageBodyPartCache;
         if(_loc2_ == null)
         {
            _loc2_ = new AvatarImageBodyPartCache();
            this.var_257.add(param1,_loc2_);
         }
         return _loc2_;
      }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_84)
         {
            this.var_84 = this._structure.getCanvas(this._scale,this.var_764);
            if(!this.var_84)
            {
               return null;
            }
            this.var_2400 = new Point(0,this.var_84.height - int(this.var_84.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1775[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_714 || _loc10_ == AvatarAction.const_404;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1444 = this.var_116.bodyPartId;
               this.var_178 = this.var_116.partType;
               this.var_1788 = this.var_116.partId;
               ...
               this.var_1445 = this._scale + "_" + this.var_116.action.assetPartDefinition + "_" + this.var_178 + "_" + this.var_1788 + "_" + _loc5_ + "_" + this._frame;
               this.var_430 = this._assets.getAssetByName(this.var_1445) as BitmapDataAsset;
               if(this.var_430 == null)
               {
                  this.var_1445 = this._scale + "_std_" + this.var_178 + "_" + this.var_1788 + "_" + _loc5_ + "_0";
                  this.var_430 = this._assets.getAssetByName(this.var_1445) as BitmapDataAsset;
               }
               if(!(!this.var_430 || !this.var_430.content))
               {
                  if(this.var_116.paletteMapId > -1)
                  {
                     this.var_1066 = this._structure.renderManager.paletteManager.getPalette(this.var_116.paletteMapId);
                     if(this.var_1066 != null)
                     {
                        this.var_938 = this.var_430.content as BitmapData;
                        this.var_177 = new BitmapData(this.var_938.width,this.var_938.height);
                        this.var_2401 = this.var_1066.colorize(this.var_938.getPixels(this.var_938.rect));
                        this.var_177.setPixels(this.var_177.rect,this.var_2401);
                     }
                     else
                     {
                        this.var_177 = (this.var_430.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1444 == AvatarBodyPartType.const_265 || this.var_1444 == AvatarBodyPartType.const_1578 || this.var_1444 == AvatarBodyPartType.const_1672) && this.var_116.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  {
                     this.var_177.colorTransform(this.var_177.rect,this.var_116.color.colorTransform);
                  }
                  if(this.var_116.isBlendable)
                  {
                     this.var_177.colorTransform(this.var_177.rect,this.var_116.blendTransform);
                  }
                  this.var_937 = this.var_430.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_53)
                     {
                  ...
                  this.var_2402 = new ImageData(this.var_177,this.var_937,_loc7_);
                  this.var_939.push(this.var_2402);
               }
            }
            _loc8_--;
         }
         ...
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2400.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_53)
            {
