package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1693:Number = 1.0;
      ...
      {
         super();
         this.var_2071 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2874 = parseInt(_loc2_,16);
         this.var_2873 = parseInt(_loc3_,16);
         this._rgb = parseInt(_loc2_,16);
         this.var_1690 = this._rgb >> 16 & 255;
         this.var_1689 = this._rgb >> 8 & 255;
         this._b = this._rgb >> 0 & 255;
         this.var_1692 = this.var_1690 / 255 * 1;
         this.var_1691 = this.var_1689 / 255 * 1;
         this.var_1693 = this._b / 255 * 1;
         if(this.var_2071 == 37)
         {
            this._alphaMultiplier = 0.5;
            this.var_2872 = false;
         }
         this.var_802 = new ColorTransform(this.var_1692,this.var_1691,this.var_1693,this._alphaMultiplier);
         this.var_1313 = this.generatePaletteMapForGrayscale(this.var_2873,this.var_2874);
      }
      ...
      {
         return this.var_1313.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1313.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1313.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1313.getValue("alphas") as Array;
      }
