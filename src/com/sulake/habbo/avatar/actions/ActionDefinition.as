package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2855 = parseInt(param1.@precedence);
         this.var_2861 = String(param1.@activepartset);
         this.var_2856 = String(param1.@assetpartdefinition);
         this.var_2859 = String(param1.@lay);
         this.var_764 = String(param1.@geometrytype);
         this.var_2609 = Boolean(parseInt(param1.@main));
         this.var_2857 = Boolean(parseInt(param1.@name_6));
         this.var_2860 = Boolean(parseInt(param1.@animation));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "com.sulake.habbo.inventory.badges")
            {
               this.var_2858 = _loc6_;
            }
            else
            {
               this.var_1975[_loc5_] = _loc6_;
            }
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1975[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2858;
         }
         return _loc2_;
      }
