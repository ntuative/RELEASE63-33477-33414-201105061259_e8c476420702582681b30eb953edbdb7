package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_257:AvatarImageCache;
      
      private var var_648:int = 0;
      
      private var var_1874:int = 0;
      
      private var var_616:AvatarFigureContainer;
      
      private var var_647:Boolean;
      
      private var var_202:Array;
      
      private var var_579:IAvatarDataContainer;
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         this.var_616 = new AvatarFigureContainer(param3);
         var _loc5_:int = this.var_616.getPartSetId("pbd");
         this.solvePetAvatarTypeAndBreed(_loc5_);
         this.var_1482 = this.var_1162;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_51)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1482);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = this._structure.getParts(_loc8_,this.var_616,_loc13_,"pet",_loc12_.getDirection(),[]);
               _loc16_ = this.var_1482 < 3;
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc10_ != null)
            {
               ...
               _loc16_ = this._structure.getParts(_loc9_,this.var_616,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               if(this._scale == AvatarScaleType.const_93)
               {
                  _loc17_ = 6;
         ...
         switch(param1)
         {
            case AvatarAction.const_430:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1829:
                  case AvatarAction.const_1597:
      ...
      private function sortActions() : void
      {
         ...
         this.var_1483 = this._structure.sortActions(this.var_339);
         ...
         {
            this.var_849 = this._structure.getCanvasOffsets(this.var_1483,this._scale,this.var_89);
         }
      }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1162 = _loc4_.id;
                     this.var_1760 = _loc4_.breed;
                     break;
                  }
               }
            }
