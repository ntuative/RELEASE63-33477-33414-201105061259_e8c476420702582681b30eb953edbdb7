package com.sulake.habbo.avatar.geometry
{
   public class GeometryItem extends Node3D
   {
      ...
      public function GeometryItem(param1:XML, param2:Boolean = false)
      {
         ...
         this.var_1392 = parseFloat(param1.@radius);
      ...
      {
         var _loc2_:Number = Math.abs(param1.z - this.transformedLocation.z - this.var_1392);
         var _loc3_:Number = Math.abs(param1.z - this.transformedLocation.z + this.var_1392);
