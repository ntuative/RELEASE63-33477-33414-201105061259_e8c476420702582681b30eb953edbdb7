package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_999:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_1051.width,this.var_1051.height,true,0);
            _loc5_ = this.var_1051.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_999.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_1000.width,this.var_1000.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_1000,this.var_1000.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
            ...
            if(this.var_999)
            {
               switch(this.var_999.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_47:
                     _loc4_.style = HabboIconType.const_885;
                     _loc4_.visible = true;
               }
            }
            else
