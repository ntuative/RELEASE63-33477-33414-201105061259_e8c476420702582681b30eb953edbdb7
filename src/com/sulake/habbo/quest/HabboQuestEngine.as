package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine
   {
      ...
      private static const const_1472:Array = ["MOVEITEM","ENTEROTHERSROOM","CHANGEFIGURE","FINDLIFEGUARDTOWER"];
      ...
      private var var_1263:QuestController;
      
      private var var_2020:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1263 = new QuestController(this);
         this.var_2020 = new AchievementController(this);
         ...
         registerUpdateReceiver(this.var_1263,3);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_37)
         {
            ...
            {
               this.var_1263.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_2020.onToolbarClick();
            }
         }
      }
      ...
      {
         return this.var_1263.questTracker.isVisible();
      }
      ...
      {
         return const_1472.indexOf(param1.localizationCode) > -1;
      }
   }
}
