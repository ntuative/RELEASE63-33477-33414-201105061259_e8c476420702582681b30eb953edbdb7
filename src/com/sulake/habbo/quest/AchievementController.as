package com.sulake.habbo.quest
{
   ...
   public class AchievementController implements IDisposable
   {
      ...
      private static const const_1049:int = 4;
      ...
      private var var_270:AchievementData;
      ...
      public function AchievementController(param1:HabboQuestEngine)
      {
         ...
         this.var_436 = new Timer(1000,1);
         this.var_436.addEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_436)
         {
            this.var_436.removeEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
            this.var_436.reset();
            this.var_436 = null;
         }
         this.var_665 = null;
      ...
      private function refreshCategoryList() : void
      {
         ...
         this.var_665.height = getLowestPoint(this.var_665);
      }
      ...
      private function refreshAchievementList() : void
      {
         ...
         this.var_829.height = getLowestPoint(this.var_829);
      }
      ...
      private function refreshAchievementsHeader() : void
      {
         ...
         this.var_1534.findChildByName("category_name_txt").caption = this._questEngine.getAchievementCategoryName(this._category);
      }
      ...
      private function refreshAchievementDetails() : void
      {
         ...
         {
            this.var_664.visible = false;
            return;
         }
         this.var_664.visible = true;
         this.var_664.findChildByName("achievement_name_txt").caption = this._questEngine.localization.getAchievementName(this.var_270.badgeId);
         this.var_664.findChildByName("achievement_desc_txt").caption = this._questEngine.localization.getAchievementDesc(this.var_270.badgeId,this.var_270.scoreLimit);
         var _loc1_:String = this._questEngine.localization.getKey("inventory.achievements.unit." + this.var_270.type,"");
         var _loc2_:String = "inventory.achievements.entrydetails." + this.var_270.levelRewardPointType;
         var _loc3_:ITextWindow = this.var_664.findChildByName("progress_txt") as ITextWindow;
         this._questEngine.localization.registerParameter(_loc2_,"currentpoints","" + this.var_270.currentPoints);
         this._questEngine.localization.registerParameter(_loc2_,"scorelimit","" + this.var_270.scoreLimit);
         this._questEngine.localization.registerParameter(_loc2_,"levelrewardpoints","" + this.var_270.levelRewardPoints);
      ...
      private function prepareWindow() : void
      {
         ...
         this._window.center();
         this.var_665 = IWindowContainer(this._window.findChildByName("categories_cont"));
         this.var_1534 = IWindowContainer(this._window.findChildByName("achievements_header_cont"));
         this.var_829 = IWindowContainer(this._window.findChildByName("achievements_cont"));
         this.var_664 = IWindowContainer(this._window.findChildByName("achievement_cont"));
         this.var_1583 = IWindowContainer(this._window.findChildByName("footer_cont"));
      }
      
      private function refreshCategoryEntry(param1:Boolean, param2:int, param3:AchievementCategory) : Boolean
      {
         var _loc4_:IWindowContainer = IWindowContainer(this.var_665.getChildByName("" + param2));
         if(_loc4_ == null)
         {
            if(!param1)
            {
            ...
            _loc4_.x = (_loc4_.width + const_1051) * (param2 % const_1049);
            _loc4_.y = (_loc4_.height + const_1051) * Math.floor(param2 / const_1049);
         }
      ...
      {
         var _loc5_:* = null;
         var _loc4_:IWindowContainer = IWindowContainer(this.var_829.getChildByName("" + param2));
         if(_loc4_ == null)
         {
            if(!param1)
            {
            ...
            _loc4_.x = _loc4_.width * (param2 % const_1050);
            _loc4_.y = _loc4_.height * Math.floor(param2 / const_1050);
         }
         _loc4_.findChildByName("bg").id = param2;
         if(param1)
         {
            this.refreshBadgeImage(_loc4_,param3);
            _loc4_.findChildByName("bg").color = param3 == this.var_270 ? 13369344 : uint(255);
            _loc4_.visible = true;
         }
         else
         {
      ...
      private function onSelectAchievement(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_270 = this._category.achievements[_loc3_];
         Logger.log("Achievement: " + this.var_270.badgeId);
         this.refresh();
      }
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc4_:BitmapData = this.var_1190[param2.badgeId];
         if(_loc4_ == null)
         {
            _loc4_ = this._questEngine.sessionDataManager.getBadgeImage(param2.badgeId);
            this.var_1190[param2.badgeId] = _loc4_;
         }
      ...
      {
         Logger.log("Got badge: " + param1.badgeId + ", " + this.var_436.running);
         this.var_1190[param1.badgeId] = param1.badgeImage;
