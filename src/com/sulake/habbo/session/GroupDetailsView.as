   ...
   public class GroupDetailsView
   {
      ...
      private function showGroupInfoDialog(param1:int) : void
      {
         ...
         if(this.var_153 == null)
         {
            ...
            if(_loc3_ != null)
            {
               this.var_153 = this._sessionManager.windowManager.createWindow("habbo_group_details_window","${group.window.title}",HabboWindowType.const_153,HabboWindowStyle.const_30,0 | 0,new Rectangle(10,10,300,220),null) as IWindowContainer;
