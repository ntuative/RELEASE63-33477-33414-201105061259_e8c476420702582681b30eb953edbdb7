package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1369:String = "sendAccessTokenToServer";
      
      private static const const_1368:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1369,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1368,this.jsFaceBookLogOutCallback);
