package com.sulake.habbo.session
{
   ...
   public class UserDataManager implements IUserDataManager
   {
      ...
      private static const const_1460:int = 2;
      
      private static const const_1899:int = 3;
      ...
      {
         return this.getUserDataByType(param1,const_1461);
      }
      ...
      public function getUserBadges(param1:int) : Array
      {
         ...
         var _loc2_:* = this.var_1017.getValue(param1) as Array;
         if(_loc2_ == null)
         {
            _loc2_ = [];
         }
      ...
      {
         this.var_1017.remove(param1);
         this.var_1017.add(param1,param2);
      }
      ...
      {
         return this.getUserDataByType(param1,const_1460);
      }
