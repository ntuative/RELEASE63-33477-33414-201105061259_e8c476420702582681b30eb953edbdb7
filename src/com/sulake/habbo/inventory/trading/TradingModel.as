package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1651:uint = 9;
      
      public static const const_224:uint = 0;
      
      public static const const_197:uint = 1;
      
      public static const const_432:uint = 2;
      
      public static const const_312:uint = 3;
      
      public static const const_510:uint = 4;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_53.updateItemList(this.var_792);
         this.var_53.updateItemList(this.var_1475);
      ...
      public function close() : void
      {
         if(this.var_765)
         {
            if(this._state != const_224 && this._state != const_240)
            {
      ...
      {
         this.var_53.setMinimized(param1 != InventoryCategory.const_80);
         this._inventory.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_791 + " OTHER: " + this.var_1196);
         ...
         {
            case const_224:
               if(param1 == const_197 || param1 == const_240)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_53.alertPopup(TradingView.const_1128);
         }
         else if(param1 is TradingAcceptEvent)
         {
            ...
            {
               this.var_1196 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_53.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            {
               this.var_53.alertPopup(TradingView.const_1109);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_261.length < const_1651)
         {
