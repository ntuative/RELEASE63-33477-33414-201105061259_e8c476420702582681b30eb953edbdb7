package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private var var_657:ItemPopupCtrl;
      ...
      private var var_1010:GroupItem;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_657 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1981 = this.createMinimizedWindow();
         }
         if(!this.var_2712)
         {
            return this.var_68;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_68)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_17.ownUserAccepts ? uint(const_1045) : uint(const_1044);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_17.otherUserAccepts ? uint(const_1045) : uint(const_1044);
            }
         ...
         if(this.var_68)
         {
            ...
            switch(this.var_17.state)
            {
               ...
               case TradingModel.const_432:
                  ...
                  break;
               case TradingModel.const_312:
                  _loc1_.enable();
                  _loc1_.caption = "${inventory.trading.confirm}";
                  this.showInfoMessage("${inventory.trading.info.confirm}");
                  break;
               case TradingModel.const_510:
                  _loc1_.disable();
      ...
      public function removeSelection() : void
      {
         if(this.var_1010)
         {
            this.var_1010.isSelected = false;
            this.var_1010 = null;
         }
      }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1588)
            {
            ...
            this.var_657.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_584);
            this.var_657.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_657.hideDelayed();
         }
      }
         ...
         if(this.var_188.length > 0)
         {
            ...
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_17.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_17.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_657.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_584);
               }
            }
            else
            {
