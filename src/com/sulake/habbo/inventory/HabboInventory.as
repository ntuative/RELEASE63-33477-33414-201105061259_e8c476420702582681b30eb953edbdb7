package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_2146:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this._roomSessionManager != null)
         {
            ...
            this._roomSessionManager.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_576,this.roomSessionEventHandler);
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_51.getValue(InventorySubCategory.const_351));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_51.getValue(InventoryCategory.const_704));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_51.getValue(InventoryCategory.const_341));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_51.getValue(InventoryCategory.const_151));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_51.getValue(InventoryCategory.const_396) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1429 = new IncomingMessages(this);
      ...
      {
         this.var_349 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._roomSessionManager.events.addEventListener(RoomSessionPropertyUpdateEvent.const_576,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_95:
               this.var_1115 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_576:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_349 || !this._config || !this._catalog || !this._avatarRenderer || !this._roomSessionManager || !this._toolbar || !this._soundManager)
         {
            return;
         }
         ...
         this.var_51.add(InventoryCategory.const_396,_loc1_);
         ...
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_349);
         this.var_51.add(InventoryCategory.const_341,_loc3_);
         ...
         this.var_51.add(InventoryCategory.const_704,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_349);
         ...
         this.var_51.add(InventorySubCategory.const_351,_loc6_);
         ...
         this.var_51.add(InventoryCategory.const_151,_loc8_);
         this.var_928 = [];
         this.var_926 = [];
         this.var_194 = true;
         if(this.var_2326)
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_351:
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_927.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_927.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_927.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_927.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2146);
         }
      }
      ...
      public function addUnseenFloorItems(param1:Array) : void
      {
         ...
         {
            if(this.var_928.indexOf(_loc2_) == -1)
            {
      ...
      public function addUnseenWallItems(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            if(this.var_926.indexOf(_loc2_) == -1)
            {
      ...
      {
         var _loc1_:int = this.var_928.length + this.var_926.length;
         if(_loc1_ != this.var_2327)
         {
      ...
      public function resetUnseenItems(param1:int) : void
      {
         ...
         switch(param1)
         {
            case UnseenItemCategoryEnum.const_874:
               ...
               break;
            case UnseenItemCategoryEnum.const_873:
