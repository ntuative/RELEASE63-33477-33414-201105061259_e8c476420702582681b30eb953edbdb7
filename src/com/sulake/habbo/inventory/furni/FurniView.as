package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_1892:int = 42;
      
      private const const_1893:int = 120;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_451.add(FurniModel.const_46,new FurniGridView(this.var_66,FurniModel.const_46,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_451.add(FurniModel.const_49,new FurniGridView(this.var_66,FurniModel.const_49,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_451.getValue(this.var_452);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_66.getCategoryContent(this.var_452);
         ...
         {
            _loc2_ = this.const_1894;
         }
         if(this.var_2620 == _loc2_)
         {
            return;
         }
         this.var_2620 = _loc2_;
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_66.getGroupItemInIndex(_loc3_,this.var_452);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            ...
            _loc18_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_204);
            ...
            if(_loc5_.category == FurniCategory.const_362)
            {
         ...
         if(_loc5_ != null)
         {
            if(_loc5_.category == FurniCategory.const_1126)
            {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1893)
         {
            _loc3_ = this.const_1893;
         }
         else if(_loc3_ < this.const_1892)
         {
            _loc3_ = this.const_1892;
         }
         else
         {
