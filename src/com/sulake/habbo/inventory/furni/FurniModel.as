package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      private static const const_1554:int = 100;
      
      private static const const_1555:int = 1000;
      ...
      private var var_2115:Vector.<Array>;
      
      private var var_2116:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_704 = new Timer(const_1554,1);
         this.var_704.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2943 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_183,this.onObjectPlaced);
               }
            ...
            {
               this.var_704.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_704.stop();
               this.var_704 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_46)
            {
               ...
               {
                  this.var_2115 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_2115;
            }
            else
            {
               if(this.var_2116 == null)
               {
                  this.var_2116 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_2116;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_362)
         {
         ...
         if(this.var_1087 == null)
         {
            this.var_1087 = this._windowManager.buildFromXML(this.var_2943) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_1087.clone() as IWindowContainer;
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_396);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_705.add(const_46,new Array());
         this.var_705.add(const_49,new Array());
         if(this._view != null)
         {
      ...
      {
         return getTimer() < this.var_2942 + const_1555;
      }
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_351;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_322 || _loc3_.category == FurniCategory.const_362 || _loc3_.category == FurniCategory.const_353)
         {
            if(param1)
            {
               return false;
      ...
      {
         return this.var_705.getValue(param1);
      }
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc3_:Array = this.var_705.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            _loc4_ = 0;
            while(_loc4_ < _loc3_.length)
            {
               ...
               if(_loc5_.category == FurniCategory.const_962)
               {
                  _loc6_ = 1;
               }
               _loc7_ = 0;
      ...
      {
         this._controller.resetUnseenItems(UnseenItemCategoryEnum.const_874);
         this._controller.resetUnseenItems(UnseenItemCategoryEnum.const_873);
      }
   }
}
