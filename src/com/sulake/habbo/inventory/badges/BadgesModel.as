package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_2145:int = 5;
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.var_925.length)
         {
            if(this.var_925[_loc2_] == param1)
            {
               this.var_925.splice(_loc2_,1);
      ...
      public function updateBadge(param1:String, param2:Boolean) : void
      {
         ...
         else
         {
            ...
            _loc8_.iconImage = this.var_349.getBadgeImage(param1);
