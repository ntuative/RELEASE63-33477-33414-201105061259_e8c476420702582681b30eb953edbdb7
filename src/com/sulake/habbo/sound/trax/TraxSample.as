package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSample implements IDisposable
   {
      ...
      public static const const_1575:String = "sample_44khz";
      
      public static const const_1638:String = "sample_22khz";
      
      public static const const_1764:String = "sample_11khz";
      
      public static const const_1751:String = "sample_16bit";
      
      public static const const_1708:String = "sample_8bit";
      ...
      public function TraxSample(param1:ByteArray, param2:int, param3:String = "sample_44khz", param4:String = "sample_16bit")
      {
         ...
         var _loc6_:int = this.var_170 * this.var_74;
         ...
         while(_loc11_ < _loc10_)
         {
            ...
            {
               this.var_125[int(_loc11_ / this.var_170)] = _loc9_;
               _loc9_ = 0;
            }
            _loc11_++;
         }
      ...
      {
         return this.var_125.length * this.var_170 * this.var_74;
      }
      ...
      public function setSample(param1:Vector.<int>, param2:int, param3:int, param4:int) : int
      {
         ...
         var _loc5_:int = this.var_170 * this.var_74;
         param4 /= _loc5_;
         if(param2 < 0)
         {
            param3 += param2;
      ...
      public function setUsageFromSong(param1:int, param2:uint) : void
      {
         ...
         if(this.var_696.indexOf(param1) == -1)
         {
            this.var_696.push(param1);
         }
      ...
      public function isUsedFromSong(param1:int) : Boolean
      {
         ...
         return this.var_696.indexOf(param1) != -1;
      }
   }
}
