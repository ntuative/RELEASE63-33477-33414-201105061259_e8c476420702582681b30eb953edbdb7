package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1535:int = HabboMusicPrioritiesEnum.const_124;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_734.push(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_734.push(new UserSongDisksInventoryMessageEvent(this.onSongDiskInventoryMessage));
         for each(_loc5_ in this.var_734)
         {
            this._connection.addMessageEvent(_loc5_);
         }
         this.var_77.addEventListener(RoomEngineSoundMachineEvent.const_812,this.onJukeboxInit);
         this.var_77.addEventListener(RoomEngineSoundMachineEvent.const_239,this.onJukeboxDispose);
         this.var_77.addEventListener(RoomEngineSoundMachineEvent.const_896,this.onSoundMachineInit);
         this.var_77.addEventListener(RoomEngineSoundMachineEvent.const_709,this.onSoundMachineDispose);
         this.var_1324 = new Timer(1000);
         this.var_1324.start();
         this.var_1324.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
         this._events.addEventListener(SoundCompleteEvent.TRAX_SONG_COMPLETE,this.onSongFinishedPlayingEvent);
         _loc6_ = 0;
         while(_loc6_ < HabboMusicPrioritiesEnum.const_259)
         {
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_2088)
            {
            ...
            {
               this._events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_137,_loc2_,param1.id,-1));
            }
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               for each(_loc1_ in this.var_734)
               {
            ...
            if(this.var_77)
            {
               this.var_77.removeEventListener(RoomEngineSoundMachineEvent.const_812,this.onJukeboxInit);
               this.var_77.removeEventListener(RoomEngineSoundMachineEvent.const_239,this.onJukeboxDispose);
               this.var_77.removeEventListener(RoomEngineSoundMachineEvent.const_896,this.onSoundMachineInit);
               this.var_77.removeEventListener(RoomEngineSoundMachineEvent.const_709,this.onSoundMachineDispose);
            }
      ...
      {
         if(param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_259)
         {
            return false;
         }
      ...
      public function updateVolume(param1:Number) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < HabboMusicPrioritiesEnum.const_259)
         {
      ...
      {
         if(param1 >= 0 && param1 < this.var_404.length)
         {
            return this.var_404.getKey(param1);
         }
         return -1;
      }
      ...
      public function getSongDiskInventorySongId(param1:int) : int
      {
         if(param1 >= 0 && param1 < this.var_404.length)
         {
            return this.var_404.getWithIndex(param1);
         }
         return -1;
      }
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         while(_loc2_ < this.var_282.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               {
                  if(_loc5_.indexOf(param1[_loc6_]) != -1 && _loc3_.soundObject != null && _loc3_.id != this.var_1612)
                  {
                     _loc3_.soundObject = null;
                     _loc4_.dispose();
      ...
      private function sendNextSongRequestMessage(param1:TimerEvent) : void
      {
         ...
         this._connection.send(new GetSongInfoMessageComposer(this.var_857));
         Logger.log("Requested song info\'s : " + this.var_857);
         this.var_857 = new Array();
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               while(this.var_856.indexOf(_loc6_.id) != -1)
               {
                  this.var_856.splice(this.var_856.indexOf(_loc6_.id),1);
      ...
      {
         if(param2 == -1 || param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_259)
         {
            return false;
         }
         ...
         this.var_2088 = this.getSongRequestCountAtPriority(param1);
         this.var_1612 = param2;
         if(this._priorityPlaying <= const_1535)
         {
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2900 != param1.id || _loc3_ > this.var_2899 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2900 = param1.id;
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_569 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_77,this._connection) as IPlayListController;
      }
