package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      private var var_222:HabboMusicController;
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_222 = param2;
         this.var_734 = [];
         this.var_734.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_734.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_734)
         {
         ...
         this.var_77.addEventListener(RoomEngineSoundMachineEvent.const_771,this.onSoundMachinePlayEvent);
         this.var_77.addEventListener(RoomEngineSoundMachineEvent.const_975,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_77)
            {
               this.var_77.removeEventListener(RoomEngineSoundMachineEvent.const_771,this.onSoundMachinePlayEvent);
               this.var_77.removeEventListener(RoomEngineSoundMachineEvent.const_975,this.onSoundMachineStopEvent);
               this.var_77 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         if(this.var_466 == param1)
         {
            ...
            if(_loc2_ != null)
            {
               this.var_222.addSongInfoRequest(_loc2_.id);
            }
         }
      }
      ...
      public function stopPlaying() : void
      {
         this.var_466 = -1;
         this.var_686 = false;
         this.var_222.stop(HabboMusicPrioritiesEnum.const_124);
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         while(_loc3_ < this._playListEntries.length)
         {
            ...
            {
               _loc4_ = this.var_222.getSongInfo(param1.id) as SongDataEntry;
               if(_loc4_ != null)
               {
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_222.playSong(param1,HabboMusicPrioritiesEnum.const_124,_loc3_,0,0,0))
         {
