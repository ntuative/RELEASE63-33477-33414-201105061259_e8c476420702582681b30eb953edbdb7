package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private static const const_1444:int = 60;
      
      private static const const_1446:int = 25165823;
      
      private static const const_1445:int = 16777215;
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_997.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               ...
               case HabboSoundTypesEnum.const_1190:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1804:
            ...
            this.var_997.add(param1,_loc2_);
         }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         _loc4_.load(_loc3_);
         this.var_652.add(_loc4_,param1);
      }
      ...
      private function createTraxInstance(param1:int, param2:String, param3:Boolean = true) : TraxSequencer
      {
         ...
         var _loc5_:TraxSequencer = new TraxSequencer(param1,_loc4_,this.var_269,events);
      ...
      public function validateSampleAvailability(param1:TraxSequencer, param2:Boolean) : void
      {
         ...
         {
            if(this.var_269.getValue(int(_loc4_[_loc6_])) == null)
            {
               if(param2)
               {
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_998.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            if(this.var_183.getBoolean("trax.player.sample.memory.purge.enabled",false))
            {
               this.var_2662 = true;
            }
         }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_998 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_183 == null || this._connection == null || this._roomEngine == null || this.var_222 != null)
         {
            return;
         }
         this.var_222 = new HabboMusicController(this,events,this._roomEngine.events,this._connection);
      }
      ...
      private function onTraxLoadComplete(param1:Event) : void
      {
         ...
         this.var_222.onSongLoaded(_loc2_.id);
      }
      
      private function ioErrorHandler(param1:Event) : void
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1786,this.var_810));
         this.var_810 = -1;
         this.var_809 = null;
      }
      ...
      {
         this.var_542 = param1;
         this.var_222.updateVolume(this.var_542);
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_652.getValue(param1) != null)
         {
            _loc2_ = this.var_652.remove(param1);
            if(this.var_269.getValue(_loc2_) == null)
            {
               this.var_1517.clear();
               _loc3_ = param1.length;
               param1.extract(this.var_1517,int(_loc3_ * 44.1));
               _loc4_ = new TraxSample(this.var_1517,_loc2_,TraxSample.const_1575,TraxSample.const_1751);
               this.var_269.add(_loc2_,_loc4_);
            }
         }
      }
      ...
      private function processLoadedSamples() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(this.var_1231.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1444 && this.var_1231.length > 0)
            {
               _loc3_ = this.var_1231.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_652.length == 0 && this.var_810 != -1)
            {
               this.var_809.ready = true;
               _loc4_ = this.var_810;
               this.var_810 = -1;
               this.var_809 = null;
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_809 == null && this.var_1232.length > 0)
         {
      ...
      private function processSampleMemoryUsage() : void
      {
         ...
         var _loc1_:* = 0;
         var _loc2_:* = [];
         var _loc3_:Array = this.var_222.samplesIdsInUse;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_269.length)
         {
            _loc5_ = this.var_269.getKey(_loc4_);
            _loc6_ = this.var_269.getWithIndex(_loc4_);
         ...
         if(_loc1_ > const_1446)
         {
            ...
            _loc8_ = 0;
            _loc9_ = 0;
            while(_loc8_ < _loc1_ - const_1445 && _loc9_ < _loc2_.length)
            {
            ...
            if(_loc7_.length > 0)
            {
               for each(_loc11_ in _loc7_)
               {
                  ...
                  _loc12_ = this.var_269.getValue(_loc11_) as TraxSample;
                  _loc12_.dispose();
                  this.var_269.remove(_loc11_);
               }
               this.var_222.samplesUnloaded(_loc7_);
            }
         }
      }
