package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_740)
         {
            this.var_740 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_740)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_739)
         {
            this.var_739 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_739)
            {
               return;
            }
