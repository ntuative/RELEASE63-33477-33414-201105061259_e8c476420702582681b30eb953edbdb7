package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_338:String = "TUI_NAME_VIEW";
      
      public static const const_444:String = "TUI_CLOTHES_VIEW";
      
      public static const const_615:String = "TUI_GUIDEBOT_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_33.events.addEventListener(HabboHelpTutorialEvent.const_574,this.onTaskDoneEvent);
         this.var_33.events.addEventListener(HabboHelpTutorialEvent.const_522,this.onTaskDoneEvent);
         this.var_33.events.addEventListener(HabboHelpTutorialEvent.const_523,this.onTaskDoneEvent);
         if(this.var_33.sessionDataManager != null)
         {
            this.var_33.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_319,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1198 && this.var_1199 && this.var_1477;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_33)
         {
            this.var_33.events.removeEventListener(HabboHelpTutorialEvent.const_574,this.onTaskDoneEvent);
            this.var_33.events.removeEventListener(HabboHelpTutorialEvent.const_522,this.onTaskDoneEvent);
            this.var_33.events.removeEventListener(HabboHelpTutorialEvent.const_523,this.onTaskDoneEvent);
            if(this.var_33.sessionDataManager != null)
            {
               this.var_33.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_319,this.onFigureUpdate);
            }
            this.var_33 = null;
         }
      }
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_574:
               this.var_1477 = true;
               if(this.var_43 != null && this.var_43.id == const_615)
               {
                  this.showView(const_94);
               }
               break;
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2196 = this._window.width - _loc2_.width;
         ...
         this._window.height = _loc2_.height + this.var_2194;
         this._window.width = _loc2_.width + this.var_2196;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_43 != null && (this.var_43.id == const_338 || this.var_43.id == const_94))
         {
            this.showView(const_94);
         }
      }
      ...
      {
         this.var_1198 = true;
         if(this.var_43 != null && (this.var_43.id == const_444 || this.var_43.id == const_94))
         {
            this.showView(const_94);
         }
      }
