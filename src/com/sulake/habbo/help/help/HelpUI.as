package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      {
         this.var_347 = this._defaultViewId;
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201105061253));
         this._toolbar = param5;
         this.var_108 = new Map();
         this.var_108.add(HabboHelpViewEnum.const_1585,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_108.add(HabboHelpViewEnum.const_215,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_108.add(HabboHelpViewEnum.const_491,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_108.add(HabboHelpViewEnum.const_328,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_108.add(HabboHelpViewEnum.const_249,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_108.add(HabboHelpViewEnum.const_401,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_108.add(HabboHelpViewEnum.const_942,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_108.add(HabboHelpViewEnum.const_282,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_108.add(HabboHelpViewEnum.const_1188,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_108.add(HabboHelpViewEnum.const_1229,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_108.add(HabboHelpViewEnum.const_902,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_488.length == 0 || param1 != this.var_347)
            {
               this.var_488.push(this.var_347);
            }
         }
         this.var_347 = param1;
         ...
         if(_loc3_ == null)
         {
            Logger.log("* No view controller found for " + this.var_347);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            ...
            case CallForHelpResultEnum.const_1150:
               ...
               break;
            case CallForHelpResultEnum.const_1192:
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_108.getValue(HabboHelpViewEnum.const_215) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_21.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_574));
      }
      ...
      {
         return this.var_108.getValue(this.var_347);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2196 = this._window.width - _loc3_.width;
         this.var_2194 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2194;
         this._window.width = _loc1_.width + this.var_2196;
      }
      ...
      {
         if(this.var_488.length > 0)
         {
            this.showUI(this.var_488.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_347 == HabboHelpViewEnum.const_215)
         {
            return;
         }
         ...
         var _loc2_:IBitmapWrapperWindow = this.var_346.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_347 == HabboHelpViewEnum.const_215 || this.var_488.length == 0)
         {
            return;
         }
         if(this.var_346 == null)
         {
            ...
            this.var_346 = this._windowManager.buildFromXML(XML(_loc2_.content)) as IWindowContainer;
            _loc3_ = this.var_346.findChildByName("back_image");
            if(_loc3_ != null)
            {
            ...
            _loc4_ = this.var_346.findChildByName("back_text");
            if(_loc4_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_346 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_346 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_346 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
