package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      private static const const_1435:String = "poster";
       
      
      public const const_1972:int = 1;
      
      public const const_2112:int = 2;
      
      public const const_2205:int = 3;
      ...
      private var var_220:MarketplaceConfirmationDialog;
      ...
      private var var_2911:MarketplaceItemStats;
      ...
      public function dispose() : void
      {
         ...
         {
            this.disposeOffers(this.var_284);
            this.var_284 = null;
         }
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!this.var_220)
         {
            this.var_220 = new MarketplaceConfirmationDialog(this,this._catalog,this._roomEngine);
         }
         this.var_220.showConfirmation(param1,param2);
      }
      ...
      {
         this.requestOffers(this.var_2910,this.var_2909,this.var_2263,this.var_2908);
      }
      ...
      {
         if(!this.var_284 || !this._catalog || !this._catalog.getPurse())
         {
            return;
         }
         var _loc2_:MarketPlaceOfferData = this.var_284.getValue(param1) as MarketPlaceOfferData;
         if(!_loc2_)
         {
            return;
         }
      ...
      public function onOffers(param1:IMessageEvent) : void
      {
         ...
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            this.var_284.add(_loc4_.offerId,_loc5_);
         }
         if(this._visualization != null)
         {
            this._visualization.listUpdatedNotify();
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_2734 = _loc3_.creditsWaiting;
         for each(_loc4_ in _loc3_.offers)
         {
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         {
            item = this.var_284.remove(parser.requestedOfferId);
            if(item != null)
            {
               item.dispose();
            }
         ...
         {
            updateItem = this.var_284.getValue(parser.requestedOfferId) as MarketPlaceOfferData;
            if(updateItem)
            {
               updateItem.offerId = parser.offerId;
               updateItem.price = parser.newPrice;
               --updateItem.offerCount;
               this.var_284.add(parser.offerId,updateItem);
            }
            this.var_284.remove(parser.requestedOfferId);
            this.showConfirmation(this.const_2112,updateItem);
            if(this._visualization != null)
            {
               this._visualization.listUpdatedNotify();
            }
      ...
      {
         if(param1.furniCategoryId != this.var_2568 || param1.furniTypeId != this.var_2573)
         {
            return;
         }
      ...
      private function isPosterItem(param1:IMarketPlaceOfferData) : Boolean
      {
         ...
         if(param1.furniType == 2 && param1.stuffData != null)
         {
            ...
            {
               _loc4_ = _loc3_.name;
               if(_loc4_ != null && _loc4_ == const_1435)
               {
                  _loc2_ = true;
               }
            }
