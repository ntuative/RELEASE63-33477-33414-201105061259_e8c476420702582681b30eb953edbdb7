package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_642 != const_1038;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1897 != RecyclerStatusMessageEvent.const_1196;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_642 == const_459;
      }
      ...
      {
         this.var_642 = const_1037;
         this.var_118 = new Array(const_210);
         if(param1 == null)
         {
            return;
         }
      ...
      public function cancel() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < const_210)
         {
            this.releaseSlot(_loc1_);
            _loc1_++;
         }
         this.var_642 = const_1038;
      }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         {
            case RecyclerStatusMessageEvent.const_1610:
               this.var_642 = const_459;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1196:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1732:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1237:
               ...
               break;
            case RecyclerFinishedMessageEvent.const_1639:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_118.length > 0)
         {
            ...
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_210)
            {
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_118.length < const_210)
         {
            return false;
         }
         var _loc1_:int = 0;
