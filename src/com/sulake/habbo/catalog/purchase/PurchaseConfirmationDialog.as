package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_2179:int = 10;
      ...
      private const const_1877:uint = 4.293848814E9;
      
      private const const_1876:uint = 4.294967295E9;
      
      private const const_1468:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_2007 = _loc1_.stuffTypes;
            this.var_833 = _loc1_.boxTypes;
            this.var_832 = _loc1_.ribbonTypes;
            this.var_1260 = this.var_2007[0];
            this.var_392 = this.var_833[0];
            this.var_391 = this.var_832[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_391 < 0)
         {
            this.var_391 = this.var_832.length - 1;
         }
         if(this.var_391 > this.var_832.length - 1)
         {
            this.var_391 = 0;
         }
         if(this.var_392 < 0)
         {
            this.var_392 = this.var_833.length - 1;
         }
         if(this.var_392 > this.var_833.length - 1)
         {
            this.var_392 = 0;
         }
         var _loc1_:int = this.var_833[this.var_392] * 1000 + this.var_832[this.var_391];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_93.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1260,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_2007;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1260);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_833[this.var_392]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_832[this.var_391]);
         this._catalog.purchaseProductAsGift(this.var_1542,this.var_93,this.var_1541,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this.var_1542,this.var_93.offerId,this.var_1541);
               this.dispose();
               break;
            case "cancel_button":
         ...
         switch(param1.type)
         {
            case WindowEvent.const_103:
               ...
               for each(_loc7_ in this.var_225)
               {
                  ...
                  if(_loc5_.length >= this.const_2179)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2758 = _loc3_.text;
               break;
      ...
      {
         if(this.var_272 == null || !this.var_272.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_272.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_272 == null)
         {
            this.var_272 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_668 == null)
         {
            this.var_668 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_668.procedure = this.suggestionsEventHandler;
         }
         if(this.var_272 == null || this.var_668 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_272.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_668.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1468;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1877) : uint(this.const_1876);
      }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = this.var_272.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1260;
               }
            }
            _loc4_++;
         }
