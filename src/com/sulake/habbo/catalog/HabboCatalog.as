package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private static const const_654:uint = 1;
      ...
      private var var_175:CatalogViewer;
      
      private var var_350:ICatalogNavigator;
      ...
      private var var_220:PurchaseConfirmationDialog;
      ...
      private var var_2226:GiftWrappingConfiguration;
      
      private var var_1116:ClubGiftController;
      ...
      private var var_894:IPurchasableOffer;
      
      private var var_1388:IDragAndDropDoneReceiver;
      
      private var var_62:PlacedObjectPurchaseData;
      
      private const const_1002:Point = new Point(100,20);
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1686);
               return;
            }
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NOT_READY));
            _loc2_ = this.var_349.loadProductData(this);
            if(_loc2_)
            {
               this.init();
            }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         if(param1 is Offer)
         {
            if(this.var_220 == null)
            {
               this.var_220 = new PurchaseConfirmationDialog(this._localization);
            }
            _loc5_ = [];
            ...
            this.var_220.showOffer(this,param1,param2,param3,_loc5_);
            if(param4)
            {
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_183,this.onObjectPlaced);
      }
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_350.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      {
         return this.var_349.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_349.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_65)
         {
            _loc3_ = this.var_349.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_724.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_102.getActivityPointsForType(Purse.const_209)));
         var _loc1_:int = 0;
      ...
      {
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_127,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            this.setHabboToolbarIcon();
            this.var_349.loadProductData(this);
         }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_175.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_350 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_175 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_175.habboCatalog = this;
      }
      
      private function createMainWindow() : void
      {
         var _loc1_:XmlAsset = assets.getAssetByName("catalog") as XmlAsset;
         this._mainContainer = this._windowManager.buildFromXML(_loc1_.content as XML,const_654) as IWindowContainer;
         this._mainContainer.tags.push("habbo_catalog");
         this._mainContainer.position = this.const_1002;
         this.hideMainWindow();
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_85:
               this.var_1675 = param1.session.isPrivateRoom;
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1116 = new ClubGiftController(this);
         }
      }
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_175 != null)
         {
            this.var_175.catalogWindowClosed();
         }
         if(this.var_91 != null && this.getCurrentLayoutCode() == "recycler")
         {
            this.var_91.cancel();
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_350.buildCatalogIndex(_loc2_);
         if(this.var_723 && this.var_723 != "")
         {
            this.var_350.openPage(this.var_723);
            this.var_723 = "";
            this.var_893 = -1;
         }
         else if(this.var_893 > -1)
         {
            this.var_350.openPageById(this.var_893,this.var_1676);
            this.var_893 = -1;
            this.var_1676 = -1;
            this.var_723 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_175.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      private function onApproveNameResult(param1:ApproveNameMessageEvent) : void
      {
         ...
         this.var_175.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result,_loc2_.nameValidationInfo));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2228 && this._soundManager != null)
         {
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_73,this.var_102.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1299);
         }
         this.var_2227 = false;
         if(this.var_295 != null)
         {
         ...
         if(_loc2_.type == Purse.const_209)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1116.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_175.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2226 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onIsOfferGiftable(param1:IsOfferGiftableMessageEvent) : void
      {
         ...
         if(this.var_220 != null)
         {
            this.var_220.onIsOfferGiftable(param1.getParser());
         }
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_724.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_724.add(_loc2_.productCode,_loc3_.slice());
            this.var_175.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      private function updateRoom(param1:String, param2:String) : void
      {
         ...
         var _loc5_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_204);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1114 && param1.type == RoomEngineObjectEvent.const_183)
         {
            ...
            _loc3_ = this.var_894.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_62 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_894);
            _loc5_ = this.var_1388;
            if(_loc5_ != null)
            {
            ...
            if(_loc6_)
            {
               _loc6_.getModelController().setNumber(RoomObjectVariableEnum.const_313,0.5);
            }
         }
      }
      ...
      private function onItemAddedToInventory(param1:HabboInventoryItemAddedEvent) : void
      {
         ...
         var _loc9_:int = 0;
         var _loc10_:int = 0;
         var _loc2_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_223);
         ...
         if(this.var_62 && this.var_62.productClassId == param1.classId)
         {
            if(this.var_62.roomCategory == this._roomEngine.activeRoomCategory && this.var_62.roomId == this._roomEngine.activeRoomId)
            {
               ...
               _loc6_ = this.var_62.category;
               _loc7_ = this.var_62.wallLocation;
               _loc8_ = this.var_62.x;
               _loc9_ = this.var_62.y;
               _loc10_ = this.var_62.direction;
               switch(param1.category)
               {
                  case FurniCategory.const_322:
                     if(this.var_62.extraParameter != _loc3_)
                     {
                        this._communication.getHabboMainConnection(null).send(new RequestRoomPropertySet(_loc5_));
                     }
                     break;
                  case FurniCategory.const_362:
                     if(this.var_62.extraParameter != _loc2_)
                     {
                        this._communication.getHabboMainConnection(null).send(new RequestRoomPropertySet(_loc5_));
                     }
                     break;
                  case FurniCategory.const_353:
                     if(this.var_62.extraParameter != _loc4_)
                     {
                        this._communication.getHabboMainConnection(null).send(new RequestRoomPropertySet(_loc5_));
                     }
                     break;
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_654);
            if(_loc1_ != null)
            {
