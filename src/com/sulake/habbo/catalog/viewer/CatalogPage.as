package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1861:String = "ctlg_";
       
      
      protected var var_2157:XML;
      ...
      {
         var _loc2_:String = const_1861 + param1;
         ...
         this.var_2157 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2157) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1799:
               if(this.var_1155 == null)
               {
                  this.var_1155 = new ItemGridCatalogWidget(param1);
                  this.var_35.push(this.var_1155);
               }
               break;
            ...
            case CatalogWidgetEnum.const_1728:
               ...
               break;
            case CatalogWidgetEnum.const_1718:
            ...
            case CatalogWidgetEnum.const_1719:
               ...
               break;
            case CatalogWidgetEnum.const_1558:
