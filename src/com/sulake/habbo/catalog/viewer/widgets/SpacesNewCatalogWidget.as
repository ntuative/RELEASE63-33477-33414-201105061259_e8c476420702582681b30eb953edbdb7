package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesNewCatalogWidget extends ItemGridCatalogWidget implements IDisposable, ICatalogWidget, IItemGrid
   {
      ...
      private var var_421:ISelectorWindow;
      ...
      public function SpacesNewCatalogWidget(param1:IWindowContainer)
      {
         ...
         super(param1);
         this.var_421 = _window.findChildByName("groups") as ISelectorWindow;
         if(this.var_421)
         {
            _loc2_ = 0;
            while(_loc2_ < this.var_421.numSelectables)
            {
               _loc3_ = this.var_421.getSelectableAt(_loc2_);
      ...
      override public function init() : Boolean
      {
         ...
         this.switchCategory(this.var_100[this.var_512]);
      ...
      {
         var _loc2_:int = this.var_605[this.var_512];
         var _loc3_:Offer = this.var_198[this.var_512][_loc2_];
      ...
      {
         var _loc2_:* = null;
         if(param1 > -1 && param1 < var_481.numGridItems)
         {
            _loc2_ = this.var_198[this.var_512][param1];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         this.var_605[this.var_512] = (this.var_198[this.var_512] as Array).indexOf(_loc2_);
         this.updateRoomPreview();
      }
      
      private function updateRoomPreview() : void
      {
         var _loc1_:int = this.var_605[0];
         var _loc2_:int = this.var_605[1];
         var _loc3_:int = this.var_605[2];
      ...
      private function createOfferGroups() : Boolean
      {
         ...
         for each(_loc1_ in page.offers)
         {
            ...
            if(!(_loc2_.productType == ProductTypeEnum.const_65 || _loc2_.productType == ProductTypeEnum.const_84))
            {
               continue;
            }
      ...
      private function onSelectGroup(param1:WindowEvent) : void
      {
         ...
         if(_loc2_)
         {
            _loc3_ = this.var_421.getSelectableIndex(_loc2_);
      ...
      private function switchCategory(param1:String) : void
      {
         ...
         this.var_421.setSelected(this.var_421.getSelectableByName(param1));
         var _loc2_:int = -1;
         switch(param1)
         {
            case "group.walls":
         ...
         if(_loc2_ > -1)
         {
            ...
            if(var_481)
            {
               var_481.destroyGridItems();
            }
            page.replaceOffers(this.var_198[this.var_512],false);
            resetTimer();
            populateItemGrid();
            ...
            _loc3_ = this.var_605[this.var_512];
