package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1219:ITextWindow;
      
      private var var_85:IBitmapWrapperWindow;
      
      private var var_1924:Point;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_991 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1219 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_85 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1924 = new Point(this.var_85.x,this.var_85.y);
         ...
         this.var_1925 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_991.text = _loc4_;
         this.var_1219.text = _loc5_;
         this.var_991.height = this.var_991.textHeight + 5;
         this.var_1219.y = this.var_991.y + this.var_991.height;
         this.var_1219.height = Math.max(130,this.var_1219.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_591:
                  _loc6_ = this.var_1925.clone();
                  if(this.var_537 != null)
                  {
                     this.var_537.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_537,this.var_1506,this.var_2022);
                     ...
                     case ProductTypeEnum.const_220:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_358,AvatarAction.const_635);
                              _loc16_.appendAction(AvatarAction.const_359,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2602)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2602 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_85 != null && true)
         {
            ...
            this.var_85.x = this.var_1924.x;
            this.var_85.y = this.var_1924.y;
            if(param3 != null)
            {
