package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RoomPreviewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IDragAndDropDoneReceiver
   {
      ...
      private var var_385:BitmapData = null;
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_25 && this.var_604 != null && this.var_604 == param2)
         {
            if(this.var_93)
            {
               (page.viewer.catalog as HabboCatalog).requestSelectedItemToMover(this,this.var_93);
               this.var_604 = null;
            }
         }
      ...
      private function onUpdateRoomPreview(param1:CatalogWidgetUpdateRoomPreviewEvent) : void
      {
         ...
         {
            this.var_1974 = _loc3_.id;
            this.var_1973 = _loc4_.id;
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(this.var_385 != null && this._imageStoreWindow != null)
         {
            this.setRoomImage(this.var_385,this._imageStoreWindow);
         }
      }
   }
}
