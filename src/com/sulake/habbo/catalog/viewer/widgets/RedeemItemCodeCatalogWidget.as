package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1034.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_1034 = null;
         }
         if(this.var_1033 != null)
         {
            this.var_1033.removeEventListener(WindowKeyboardEvent.const_173,this.windowKeyEventProcessor);
            this.var_1033 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1034 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_1034 != null)
         {
            this.var_1034.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_1033 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1033 != null)
         {
            this.var_1033.addEventListener(WindowKeyboardEvent.const_173,this.windowKeyEventProcessor);
         }
         return true;
      }
