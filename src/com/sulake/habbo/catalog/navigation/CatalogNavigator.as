package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_3033:String = "magic.credits";
      
      private var var_2989:String = "magic.pixels";
      
      private var var_2990:String = "catalog.page.club";
      ...
      {
         this.openPage(this.var_2989);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_2990,true);
      }
