package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2149:int = 1000;
      ...
      private var var_947:IWindow;
      
      public function EffectView()
      {
         super();
         this.var_207 = new Timer(this.const_2149);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_181.isActive)
         {
            ...
            this.var_946.width = _loc2_ * this.var_300;
         }
         else
         {
            this.var_946.width = 0;
            this.var_207.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_769 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_769 == null)
            {
               return;
            }
         ...
         if(!this.var_181.isActive)
         {
            this.var_769.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_769.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_769.text;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            this.var_947 = this._window.findChildByName("effect_hilite");
            this.var_947.visible = false;
         }
         this.setTimeLeft();
         this.var_946 = this._window.findChildByName("loader_bar");
         if(this.var_946 != null)
         {
            this.var_300 = this.var_946.width;
            this.var_207.start();
            this.onUpdate();
         }
