package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_1106:String = "PLSV_START_PLAYBACK";
      
      public static const const_517:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_43 != const_517)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_441[this.var_43];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_441[const_872];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_441.add(const_517,_loc1_);
