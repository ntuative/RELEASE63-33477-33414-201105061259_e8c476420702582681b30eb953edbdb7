package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_441.add(const_978,_loc1_);
            this.var_1791 = _loc1_.getChildByName("preview_play_track_name") as ITextWindow;
            this.var_1790 = _loc1_.getChildByName("preview_play_author_name") as ITextWindow;
            ...
            this.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_544));
         ...
         if(_loc1_ != null)
         {
            this.var_441.add(const_828,_loc1_);
            ...
            this.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_531));
         }
      }
