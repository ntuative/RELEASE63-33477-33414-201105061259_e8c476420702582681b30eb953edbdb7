package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_432:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_72,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1365,const_1364,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            this.var_432 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         if(this.var_432 != null)
         {
            this.var_432.setValue(this.var_1459);
         }
         this.var_523 = this.colors.indexOf(_loc2_.color);
         if(this.var_620 != null)
         {
            this.var_620.setSelectedColorIndex(this.var_523);
         }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_432 != null)
         {
            this.var_432.min = this._widget.minLights[param1 - 1];
         }
      }
