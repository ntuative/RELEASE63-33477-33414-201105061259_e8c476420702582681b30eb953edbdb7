package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= this.var_527.numGridItems)
         {
            return;
         }
         this.select(this.var_527.getGridItemAt(param1) as IWindowContainer);
      }
      
      private function populate(param1:IHabboWindowManager) : void
      {
         if(this._view == null || this.var_527 == null)
         {
            return;
         }
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         {
            _loc3_ = param1.buildFromXML(this.var_1846) as IWindowContainer;
            ...
            _loc3_.width = this.var_630.width;
            _loc3_.height = this.var_630.height;
            this.var_527.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(this.var_630.width,this.var_630.height,true,0);
               _loc4_.bitmap.copyPixels(this.var_630,this.var_630.rect,new Point(0,0));
            }
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(this.var_968.width,this.var_968.height,true,16777215);
               _loc6_.bitmap.copyPixels(this.var_968,this.var_968.rect,new Point(0,0),null,null,true);
      ...
      {
         var _loc2_:int = this.var_527.getGridItemIndex(param1.target as IWindow);
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_1846 = XML(_loc2_.content);
         _loc3_ = BitmapDataAsset(param1.getAssetByName("dimmer_color_frame"));
         this.var_630 = BitmapData(_loc3_.content);
         ...
         this.var_968 = BitmapData(_loc3_.content);
      }
