package com.sulake.habbo.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      private var var_2979:IAssetLibrary;
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2979 = param1.root.assets;
      ...
      public function createWidget(param1:String) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_429:
               _loc2_ = new RoomChatWidget(this._windowManager,assets,this.var_58,this.var_135,this.var_2392++,this,this._questEngine);
               break;
            case RoomWidgetEnum.CHAT_INPUT_WIDGET:
               if(this.var_135.getKey("new.chat.widget.enabled") == "1")
               {
                  _loc2_ = new RoomChatInputWidget(this._windowManager,assets,this.var_58,this.var_135,this);
               }
               else
               {
                  _loc2_ = new RoomChatInputWidgetOld(this._windowManager,assets,this.var_58,this.var_135,this);
               }
               break;
            case RoomWidgetEnum.const_536:
               _loc2_ = new InfostandWidget(this._windowManager,assets,this.var_58,this.var_135,this._catalog);
               break;
            case RoomWidgetEnum.const_503:
               _loc2_ = new MeMenuWidget(this._windowManager,assets,this.var_58,events,this.var_135);
               break;
            ...
            case RoomWidgetEnum.const_527:
               _loc2_ = new TeaserFurniWidget(this._windowManager,assets,this.var_58,this.var_135,this._inventory);
               break;
            ...
            case RoomWidgetEnum.const_588:
               _loc2_ = new LoadingBarWidget(this._windowManager,assets,this.var_58,this.var_135);
               break;
            case RoomWidgetEnum.const_779:
               _loc2_ = new RoomQueueWidget(this._windowManager,assets,this.var_58,this.var_135);
               break;
            case RoomWidgetEnum.const_134:
               _loc2_ = new VoteWidget(this._windowManager,assets,this.var_58,this.var_135);
               break;
            ...
            case RoomWidgetEnum.const_120:
               _loc2_ = new AvatarInfoWidget(this._windowManager,assets,this.var_135,this.var_58,this);
               break;
            ...
            case RoomWidgetEnum.const_488:
               _loc2_ = new PlayListEditorWidget(this._windowManager,this._soundManager,assets,this.var_58,this.var_135,this._catalog);
               break;
