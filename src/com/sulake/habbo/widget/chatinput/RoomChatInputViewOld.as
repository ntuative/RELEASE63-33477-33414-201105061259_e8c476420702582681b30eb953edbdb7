package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputViewOld
   {
      ...
      private static const const_1416:int = 11;
      
      private static const const_663:int = 18;
      
      private static const const_1036:int = 16;
      
      private static const const_1417:int = 20;
      ...
      public function RoomChatInputViewOld(param1:RoomChatInputWidgetOld, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         this.var_1208 = this._localization.getKey("widgets.chatinput.mode.whisper",":tell");
         this._chatModeIdShout = this._localization.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2526 = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
      ...
      private function createWindow() : void
      {
         ...
         this._window.addEventListener(WindowEvent.const_297,this.onWindowMoved);
         this.var_1624 = true;
         this.var_533 = "";
         this.refreshView();
      }
      ...
      private function refreshView() : void
      {
         ...
         this._window.width = _loc1_.width + const_663 + const_1036;
         _loc1_.x = const_663;
         _loc1_.y = const_1416;
      }
      ...
      {
         this.var_300 = param1 - (const_663 + const_1036);
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == this.var_1208 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  this.var_533 = "";
               }
      ...
      private function onWindowMoved(param1:WindowEvent) : void
      {
         ...
         this.setMaxWidth(this._window.context.getDesktopWindow().width - this._window.x - const_1417);
      }
