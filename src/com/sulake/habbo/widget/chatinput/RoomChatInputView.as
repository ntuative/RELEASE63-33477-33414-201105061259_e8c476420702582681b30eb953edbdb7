package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private const const_2199:int = 250;
      
      private const const_2198:int = 0;
      
      private const const_2200:String = "${widgets.chatinput.say}";
      
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         super();
         this._widget = param1;
         this.var_1208 = param1.localizations.getKey("widgets.chatinput.mode.whisper",":tell");
         this._chatModeIdShout = param1.localizations.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2526 = param1.localizations.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_375 = new Timer(1000,1);
         this.var_375.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_444 = new Timer(10000,1);
         this.var_444.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_444.reset();
            this.var_444.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
            this.var_444 = null;
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1623 = this._window.findChildByName("block_text");
         this.var_2101.caption = this.const_2200;
         ...
         this.var_24.addEventListener(WindowKeyboardEvent.const_173,this.windowKeyEventProcessor);
         ...
         this.var_1624 = true;
         this.var_533 = "";
         this._window.addEventListener(WindowEvent.const_851,this.updatePosition);
      ...
      private function updatePosition(param1:WindowEvent = null) : void
      {
         ...
         var _loc5_:int = this._window.desktop.width - this._window.width - this.const_2199 - _loc3_;
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ == Keyboard.BACKSPACE)
         {
            if(this.var_24 != null)
            {
               ...
               _loc8_ = _loc7_.split(" ");
               if(_loc8_[0] == this.var_1208 && _loc8_.length == 3 && _loc8_[2] == "")
               {
                  this.var_24.text = "";
                  this.var_533 = "";
               }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(_loc2_.text.length > this.var_533.length + 1)
            {
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_640);
      ...
      private function sendChatFromInputField(param1:Boolean = false) : void
      {
         ...
         var _loc2_:int = !!param1 ? 0 : int(RoomWidgetChatMessage.const_113);
