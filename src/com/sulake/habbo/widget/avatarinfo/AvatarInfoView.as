package com.sulake.habbo.widget.avatarinfo
{
   ...
   public class AvatarInfoView
   {
      ...
      private static const const_1387:int = 25;
      ...
      protected var var_2160:int = -1000000;
      
      public function AvatarInfoView(param1:AvatarInfoWidget)
      {
         this.var_2159 = new FixedSizeStack(const_1387);
         super();
         this._widget = param1;
      }
      ...
      public static function setup(param1:AvatarInfoView, param2:int, param3:String, param4:int, param5:int, param6:Boolean = false) : void
      {
         ...
         param1.var_2277 = param4;
         param1.var_2158 = param6;
         param1.updateWindow();
      }
      ...
      {
         this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_842));
      ...
      public function update(param1:Rectangle, param2:Point, param3:Number) : void
      {
         ...
         if(!this.var_1352)
         {
            ...
            if(this.var_1640 == RoomObjectTypeEnum.const_142 || this.var_1640 == RoomObjectTypeEnum.const_608)
            {
            ...
            if(_loc6_ < this.var_2160 - const_1023)
            {
               _loc6_ = this.var_2160 - const_1023;
            }
            _loc7_ = param2.y - _loc6_;
            this.var_2160 = _loc6_;
