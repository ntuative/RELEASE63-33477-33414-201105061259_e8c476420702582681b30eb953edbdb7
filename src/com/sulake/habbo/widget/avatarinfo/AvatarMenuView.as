package com.sulake.habbo.widget.avatarinfo
{
   ...
   public class AvatarMenuView extends AvatarInfoView
   {
      ...
      protected static const const_1335:uint = 0;
      
      protected static const const_370:uint = 1;
      
      protected static const const_989:uint = 2;
      
      protected static var var_1370:uint = const_370;
      
      private static const const_1482:uint = 4281149991;
      
      private static const const_1485:uint = 4283715916;
      
      private static const const_1484:uint = 16777215;
      
      private static const const_1480:uint = 9552639;
      
      private static const const_1483:uint = 16744755;
      
      private static const const_1481:uint = 16756591;
       
      
      protected var _data:AvatarInfoData;
      
      protected var var_340:uint = 1;
      ...
      protected function updateButtons() : void
      {
         ...
         if(!this.var_1362)
         {
            ...
            {
               this.var_340 = const_989;
            }
            else
            {
               this.var_340 = var_1370;
            }
         }
         if(this.var_340 == const_1335)
         {
         ...
         if(this.var_340 == const_1335 || this.var_340 == const_370)
         {
            ...
            else
            {
               ...
               this.var_340 = const_370;
            }
         }
         if(this.var_340 == const_370)
         {
            ...
            {
               case RoomWidgetUserInfoUpdateEvent.const_775:
      ...
      private function buttonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(param2.name == "button")
            {
               param2.color = const_1485;
            }
            else if(param2.tags.indexOf("link") > -1)
            {
               if(param2.tags.indexOf("actions") > -1)
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1480;
               }
               else if(param2.tags.indexOf("moderate") > -1)
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1481;
               }
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == "button")
            {
               param2.color = const_1482;
            }
            else if(param2.tags.indexOf("link") > -1)
            {
               if(param2.tags.indexOf("actions") > -1)
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1484;
               }
               else if(param2.tags.indexOf("moderate") > -1)
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1483;
               }
            }
         }
         if(_loc3_)
