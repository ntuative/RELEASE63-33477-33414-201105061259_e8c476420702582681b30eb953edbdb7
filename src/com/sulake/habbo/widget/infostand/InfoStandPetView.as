package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_2171:int = 152;
      
      private const const_2168:int = 16;
      
      private const const_1464:int = 4;
      
      private const const_2177:uint = 14342874;
      
      private const const_2166:uint = 3815994;
      
      private const const_2173:uint = 2085362;
      
      private const const_2176:uint = 39616;
      
      private const const_2174:uint = 10513106;
      
      private const const_2169:uint = 8734654;
      
      private const const_2175:uint = 9094430;
      
      private const const_2167:uint = 6200576;
      
      private const const_2178:String = "happiness";
      
      private const const_2170:String = "experience";
      
      private const const_2172:String = "energy";
      ...
      {
         if(this.var_52 == null || this.var_46 == null || this.var_94 == null)
         {
            return;
         }
         ...
         this._window.width = Math.max(this.var_46.width,this.var_94.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_46.width < this.var_94.width)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_2178,param1.nutrition,param1.nutritionMax,this.const_2176,this.const_2173);
         this.updateStateElement(this.const_2170,param1.experience,param1.experienceMax,this.const_2169,this.const_2174);
         this.updateStateElement(this.const_2172,param1.energy,param1.energyMax,this.const_2167,this.const_2175);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(this.const_2171,this.const_2168,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),this.const_2177);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,this.const_2166);
         var _loc9_:Rectangle = new Rectangle(1,1 + this.const_1464,_loc7_.width - 2,_loc7_.height - 2 - this.const_1464);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,this.const_1464);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_552) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_209 && this.var_209.getPetId() == this.var_552)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1622,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_417,this._widget.petData.ownerId);
