package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private const const_2164:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         this.var_388 = new Timer(this.const_2164);
         this.var_388.addEventListener(TimerEvent.TIMER,this.onButtonDisableTimeout);
      }
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:CommandConfiguration = this.var_1253.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
            this.disableAllButtons();
            this.requestEnabledCommands(this.var_552);
         }
         else
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1253.getValue(this.var_552) as CommandConfiguration;
      ...
      {
         this.var_1253.remove(param1);
         this.var_1253.add(param1,param2);
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_460 == null)
         {
            ...
            this.var_460 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_460 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_460.x = 200;
            this.var_460.procedure = this.onInfoWindowProcedure;
         }
         else
         {
            this.var_460.visible = true;
         }
      }
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_388,this.var_552));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_551,this.var_552,this.var_1992 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_551,this.var_552,this.var_1992 + " " + _loc5_);
