package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_2077 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1315 = this.var_2077.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1315)
         {
            this.var_1315.procedure = this.onButtonClick;
         }
         this.var_1316 = this.var_2077.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1316)
         {
            this.var_1316.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_281 >= this.var_58.length - 1)
         {
            this.var_1316.disable();
         }
         else
         {
            this.var_1316.enable();
         }
         if(this.var_281 <= 0)
         {
            this.var_1315.disable();
         }
         else
         {
            this.var_1315.enable();
         }
      }
      ...
      {
         ++this.var_281;
         this.var_281 = Math.min(this.var_281,this.var_58.length - 1);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_58[this.var_281][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_58[this.var_281][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_58[this.var_281][1]).value;
