package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      public static var var_336:int = 3;
      
      private static var var_1407:int = 2;
      ...
      private var var_1710:TriggerConfs;
      
      private var var_1711:ActionTypes;
      
      private var var_1712:ConditionTypes;
      
      private var var_250:Dictionary;
      
      private var var_34:Triggerable;
      
      private var var_738:RoomObjectHightLighter;
      
      private var var_122:UserDefinedRoomEventsHelp;
      
      private var var_1134:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1710 = new TriggerConfs();
         this.var_1711 = new ActionTypes();
         this.var_1712 = new ConditionTypes();
         this.var_250 = new Dictionary();
         super();
         this.var_77 = param1;
         this.var_738 = new RoomObjectHightLighter(param1);
         this.var_122 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         else if(this.getStuffIds().length < this.var_34.furniLimit)
         {
      ...
      {
         return this.resolveHolder().getElementByCode(this.var_34.code);
      }
      
      private function resolveHolder() : ElementTypeHolder
      {
         if(this.var_34 as TriggerDefinition != null)
         {
            return this.var_1710;
         }
         if(this.var_34 as ActionDefinition != null)
         {
            return this.var_1711;
         }
         if(this.var_34 as ConditionDefinition != null)
         {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1134 = new SliderWindowController(this.var_77,IWindowContainer(this.find(this.var_50,"delay_slider_container")),this.var_77.assets,0,20,1);
         this.var_1134.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1134.setValue(0);
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.prepareWindow();
         this.var_34 = param1;
         Logger.log("Received: " + this.var_34 + ", " + param1.code);
         var _loc2_:Element = this.resolveType();
         this.var_738.hideAll(this.var_250);
         this.var_250 = new Dictionary();
         for each(_loc3_ in this.var_34.stuffIds)
         {
            this.var_250[_loc3_] = "yes";
         }
         _loc4_ = !!_loc2_.hasSpecialInputs ? this.prepareCustomInput() : null;
         _loc2_.onEditStart(_loc4_,this.var_34);
         this.var_738.showAll(this.var_250);
         if(this.var_34 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_34);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1134.setValue(_loc6_);
         }
      ...
      private function prepareStuffSelectionForUpdate() : void
      {
         ...
         if(this.var_34.stuffTypeSelectionEnabled)
         {
            ...
            else if(_loc2_.requiresFurni == var_336)
            {
      ...
      {
         this.getFurniTypeMatchesText().caption = this.var_77.localization.getKey("wiredfurni.pickfurnis.stuffselectiontype." + this.var_34.stuffTypeSelectionCode);
      }
      ...
      private function onSave(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_34 as TriggerDefinition != null)
         {
            this.var_77.send(new UpdateTriggerMessageComposer(this.var_34.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         else if(this.var_34 as ActionDefinition != null)
         {
            this.var_77.send(new UpdateActionMessageComposer(this.var_34.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.getActionDelay(),this.resolveStuffSelectionType()));
         }
         else if(this.var_34 as ConditionDefinition != null)
         {
            this.var_77.send(new UpdateConditionMessageComposer(this.var_34.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         this.close();
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1134.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_122.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.stuffTypeSelectionCode = this.var_34.stuffTypeSelectionCode < 1 ? int(var_1407) : int(this.var_34.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_34.stuffTypeSelectionCode = (this.var_34.stuffTypeSelectionCode + 1) % (var_1407 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onApplySnapshot(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_77.send(new ApplySnapshotMessageComposer(this.var_34.id));
      }
      ...
      private function resolveStuffSelectionType() : int
      {
         ...
         if(_loc1_.requiresFurni == var_336)
         {
            return this.var_34.stuffTypeSelectionCode;
         }
         return 0;
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1710);
         this.refreshConfigureElement(this.var_1711);
         this.refreshConfigureElement(this.var_1712);
      ...
      {
         if(!param1.acceptTriggerable(this.var_34))
         {
      ...
      private function refreshHeader(param1:Element, param2:String) : void
      {
         ...
         this.setText(_loc3_,"conf_name_txt",this.getElementName(this.var_34.stuffTypeId));
         this.setText(_loc3_,"conf_desc_txt",this.getElementDesc(this.var_34.stuffTypeId));
      ...
      private function refreshConflictingTriggers() : void
      {
         ...
         var _loc1_:ActionDefinition = ActionDefinition(this.var_34);
      ...
      private function refreshConflictingActions() : void
      {
         ...
         var _loc1_:TriggerDefinition = TriggerDefinition(this.var_34);
      ...
      private function refreshSelectFurni() : void
      {
         ...
         var _loc4_:int = this.var_34.furniLimit;
