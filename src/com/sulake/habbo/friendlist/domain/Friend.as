package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_2057:int = "F".charCodeAt(0);
      
      public static const const_1992:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_935 = param1.gender;
         this.var_827 = param1.online;
         this.var_1886 = param1.followingAllowed && param1.online;
         this.var_616 = param1.figure;
         this.var_1768 = param1.motto;
         this.var_1770 = param1.lastAccess;
         this.var_1481 = param1.categoryId;
         this.var_1769 = param1.realName;
