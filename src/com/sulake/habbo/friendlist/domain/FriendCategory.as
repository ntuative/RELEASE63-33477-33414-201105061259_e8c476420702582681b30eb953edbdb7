package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      {
         return Math.ceil(this.var_225.length / const_390);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_920 * const_390;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_920 + 1) * const_390,this.var_225.length);
      }
