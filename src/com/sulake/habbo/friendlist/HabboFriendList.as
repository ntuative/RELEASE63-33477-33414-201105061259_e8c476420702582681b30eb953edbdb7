package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_2601:FriendListLookAndFeel;
      
      private var var_421:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1923:OpenedToWebPopup;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1192)
         {
            this.var_1192.release(new IIDAvatarRenderManager());
            this.var_1192 = null;
         }
         if(this.var_998)
         {
            this.var_998.release(new IIDHabboNotifications());
            this.var_998 = null;
         }
         if(this._toolbar)
         {
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1923 = new OpenedToWebPopup(this);
         }
         this.var_1923.show(x,y);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_309);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_364,HabboWindowStyle.const_44,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1192.createAvatarImage(param1,AvatarScaleType.const_93,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         this.var_998 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_100.addCategory(new FriendCategory(FriendCategory.const_1307,this.getText("friendlist.friends")));
         this.var_100.addCategory(new FriendCategory(FriendCategory.const_406,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_100.addFriend(new Friend(_loc4_));
         }
         this.var_421 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_646)
         {
         ...
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_127,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_100.findCategory(FriendCategory.const_406);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_421.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_421.findTab(FriendListTab.const_98).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_421.findTab(FriendListTab.const_98);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1922.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_421.findTab(FriendListTab.const_98);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_805 || !this._friendRequests)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_805.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_47))
         {
            _loc2_ = this._friendRequests.vipLimit;
         }
         else if(this.var_805.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_45))
         {
