package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_420:RoomInfoViewCtrl;
      
      private var var_1118:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_421:Tabs;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_420 = new RoomInfoViewCtrl(this);
         this.var_1118 = new RoomCreateViewCtrl(this);
         this.var_2233 = new RoomThumbnailRenderer(this);
         this.var_1048 = new GuestRoomPasswordInput(this);
         this.var_329 = new GuestRoomDoorbell(this);
         this.var_421 = new Tabs(this);
         this.var_1119 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_364,HabboWindowStyle.const_44,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_420.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_127,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_127,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         if(param1.type == HabboToolbarEvent.const_37)
         {
            ...
            {
               this.var_420.handleToolbarEvent(param1);
            }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_296.startSearch(Tabs.const_266,Tabs.const_433,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_296.startSearch(Tabs.const_311,Tabs.const_300);
         this.var_421.getTab(Tabs.const_311).tabPageDecorator.tabSelected();
      }
