package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function PopupCtrl(param1:HabboNavigator, param2:int, param3:int, param4:String)
      {
         ...
         this.var_450.addEventListener(TimerEvent.TIMER,this.onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_450)
         {
            this.var_450.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_450.reset();
            this.var_450 = null;
         }
         if(this.var_383)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_54 == null)
         {
            this.var_54 = IWindowContainer(this._navigator.getXmlWindow(this.var_1099));
         ...
         this.var_54.x = _loc2_.x + this.var_2596 + param1.width;
