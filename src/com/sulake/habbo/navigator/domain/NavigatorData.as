package com.sulake.habbo.navigator.domain
{
   ...
   public class NavigatorData
   {
      ...
      private static const const_1913:int = 10;
      ...
      private var var_680:RoomEventData;
      ...
      private var var_1041:PublicRoomShortData;
      ...
      public function onRoomEnter(param1:RoomEntryInfoMessageParser) : void
      {
         ...
         {
            this.var_1041 = param1.publicSpace;
            this.var_680 = null;
         }
      }
      ...
      public function set categories(param1:Array) : void
      {
         ...
         this.var_1573 = new Array();
         for each(_loc2_ in this.var_1505)
         {
            if(_loc2_.visible)
            {
      ...
      {
         var _loc2_:int = 0;
         this.var_2822 = param1.limit;
         this.var_1572 = param1.favouriteRoomIds.length;
         this._favouriteIds = new Dictionary();
      ...
      {
         return this.var_1572 >= this.var_2822;
      }
