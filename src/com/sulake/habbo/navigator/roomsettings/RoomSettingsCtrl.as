package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_465:IRoomSettingsCtrlOwner;
      ...
      private var var_1290:TextFieldManager;
      
      private var var_990:TextFieldManager;
      
      private var var_988:TextFieldManager;
      
      private var var_1048:TextFieldManager;
      
      private var var_1296:TextFieldManager;
      
      private var var_1289:ICheckBoxWindow;
      
      private var var_1292:ICheckBoxWindow;
      
      private var var_1293:ICheckBoxWindow;
      
      private var var_682:ICheckBoxWindow;
      ...
      private var var_2049:IWindowContainer;
      ...
      {
         this.var_400 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_400));
      ...
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         ...
         this._active = true;
         this.var_2048 = true;
         this.var_465.roomSettingsRefreshNeeded();
      }
      ...
      {
         if(param1 != this.var_400 || this.var_1291 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1291 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1571)
         {
            this.var_845.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1852)
         {
            this.var_845.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1560)
         {
            this.var_1290.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1633)
         {
            this.setTagError(this.var_990,param3,"${navigator.roomsettings.unacceptablewords}");
         ...
         {
            this.setTagError(this.var_990,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_988,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1847)
         {
            this.var_1048.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_845.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function clearErrors() : void
      {
         ...
         this.var_1290.clearErrors();
         this.var_990.clearErrors();
         this.var_988.clearErrors();
         this.var_1048.clearErrors();
         this.var_1296.clearErrors();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_845 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1290 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_990 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_988 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_1048 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1296 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1289 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1292 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1293 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_682 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this._thumbnailContainer = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1295 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1288 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_2049 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1583 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_280 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1294 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_1584 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1584.mouseThreshold = 0;
         this.var_1584.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1294.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_2049.visible = this._inRoom;
         if(this.var_846)
         {
            this.var_1288.visible = true;
            this.var_1583.visible = false;
            this.refreshFlatControllers();
            this.var_1288.height = Util.getLowestPoint(this.var_1288) + 4;
         }
         else
         {
            this.populateForm();
            this.var_1295.visible = true;
            this.var_1583.visible = true;
            this._thumbnailContainer.visible = this._inRoom;
            this.var_1295.height = Util.getLowestPoint(this.var_1295) + 4;
         }
         this.var_1584.text = !!this.var_846 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this._thumbnailContainer.name,this.var_1295.name,this.var_1288.name,this.var_1583.name,this.var_2049.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_845.setText(_loc1_.name);
         this.var_1290.setText(_loc1_.description);
         this.var_1048.setText("");
         this.var_1296.setText("");
         ...
         this.setTag(this.var_990,_loc1_.tags[0]);
         this.setTag(this.var_988,_loc1_.tags[1]);
         if(this.var_1289)
         {
            if(_loc1_.allowPets)
            {
         ...
         if(this.var_1292)
         {
            ...
            {
               this.var_1292.select();
            }
            else
            {
               this.var_1292.unselect();
            }
         }
         if(this.var_1293)
         {
            ...
            {
               this.var_1293.select();
            }
            else
            {
               this.var_1293.unselect();
            }
         }
         if(this.var_682)
         {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_845.getText();
         _loc2_.description = this.var_1290.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_626;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_123)
         {
            _loc8_ = this.var_1048.getText();
            _loc9_ = this.var_1296.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_1048.clearErrors();
               this.var_1296.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1289.isSelected;
         _loc2_.allowFoodConsume = this.var_1292.isSelected;
         _loc2_.allowWalkThrough = this.var_1293.isSelected;
         _loc2_.hideWalls = this.var_682.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_990,_loc2_.tags);
         this.addTag(this.var_988,_loc2_.tags);
         this.clearErrors();
         this.var_1291 = _loc2_.roomId;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_400);
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_73.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_400]);
         _loc2_.show();
      }
      ...
      {
         var _loc10_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(this.var_280.findChildByName("flat_controller_list"));
         var _loc2_:IButtonWindow = IButtonWindow(this.var_280.findChildByName("remove_flat_ctrl"));
         var _loc3_:IButtonWindow = IButtonWindow(this.var_280.findChildByName("remove_all_flat_ctrls"));
         var _loc4_:IWindow = this.var_280.findChildByName("flat_ctrls_caption_txt");
         var _loc5_:IWindow = this.var_280.findChildByName("flat_ctrls_info_txt");
         var _loc6_:IWindow = this.var_280.findChildByName("flat_ctrls_limit_txt");
         var _loc7_:IWindowContainer = IWindowContainer(this.var_280.findChildByName("flat_controllers_footer"));
         Util.hideChildren(this.var_280);
         this.var_280.findChildByName("ruler").visible = true;
         ...
         if(this.var_73.controllers.length > 0)
         {
            ...
            Util.moveChildrenToColumn(this.var_280,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc4_.y,5);
         }
         else
         {
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_72,HabboWindowStyle.const_30,HabboWindowParam.const_62,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_400));
      }
