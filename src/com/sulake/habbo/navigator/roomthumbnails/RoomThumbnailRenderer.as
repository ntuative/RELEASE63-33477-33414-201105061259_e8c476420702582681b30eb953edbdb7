package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      public static const const_570:int = 10;
      
      private static const const_1058:int = 32;
      
      private static const const_1474:int = 8;
      
      private static const const_1475:int = -16;
      
      private static const const_1473:int = 40;
      ...
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_1058 / 2);
         return new Point(param1 * const_1058 + _loc3_,param2 * const_1474);
      }
      ...
      public function refreshThumbnail(param1:IWindowContainer, param2:RoomThumbnailData, param3:Boolean) : void
      {
         ...
         if(_loc5_ == null)
         {
            ...
            _loc5_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("bitmap","",HabboWindowType.const_364,HabboWindowStyle.const_44,0 | (!!param3 ? HabboWindowParam.const_40 : HabboWindowParam.const_44),new Rectangle(0,0,_loc7_.width,_loc7_.height)));
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_1026.getImage(ThumbnailEditorModel.const_41,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_1026.getImage(ThumbnailEditorModel.const_41,1);
         }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         ...
         {
            this.var_1554 = this._navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(this.var_1554,this.var_1554.rect,new Point(0,0),null,null,true);
      }
      ...
      private function refreshObj(param1:BitmapData, param2:RoomThumbnailObjectData) : void
      {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1475,_loc4_.y + const_1473 - _loc5_.height),null,null,true);
      }
      
      public function getScreenLocForPos(param1:int) : Point
      {
         return Point(this.var_2765[param1]);
      }
   }
}
