package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      public static const const_471:int = 1;
      
      public static const const_766:int = 2;
      
      public static const const_2093:int = 3;
      ...
      private var var_1040:PopularTagsListCtrl;
      
      private var var_1039:GuestRoomListCtrl;
      
      private var var_1280:OfficialRoomListCtrl;
      ...
      private var var_1281:IRegionWindow;
      ...
      private var var_780:WindowToggle;
      
      private const const_1002:Point = new Point(100,10);
      
      public function MainViewCtrl(param1:HabboNavigator)
      {
         super();
         this._navigator = param1;
         this.var_1040 = new PopularTagsListCtrl(this._navigator);
         this.var_1039 = new GuestRoomListCtrl(this._navigator);
         this.var_1280 = new OfficialRoomListCtrl(this._navigator);
      ...
      public function onNavigatorToolBarIconClick() : Boolean
      {
         ...
         if(!this.var_780 || this.var_780.disposed)
         {
            this.var_780 = new WindowToggle(this.var_15,this.var_15.desktop,this.reloadData,this.close);
         }
         var _loc1_:int = this.var_780.toggle();
      ...
      public function open() : void
      {
         ...
         {
            this.prepare();
            this.var_15.position = this.const_1002;
            _loc1_ = true;
         }
         this.refresh();
      ...
      private function prepare() : void
      {
         ...
         this.var_184 = IWindowContainer(this.var_15.findChildByName("tab_content"));
         this.var_239 = IWindowContainer(this.var_15.findChildByName("custom_content"));
         this.var_210 = IWindowContainer(this.var_15.findChildByName("list_content"));
         this.var_275 = IWindowContainer(this.var_15.findChildByName("custom_footer"));
         this.var_1569 = this.var_15.findChildByName("loading_text");
         var _loc1_:IWindow = this.var_15.findChildByTag("close");
         _loc1_.procedure = this.onWindowClose;
         this.var_1281 = IRegionWindow(this.var_15.findChildByName("to_hotel_view"));
         if(!this.var_1281)
         {
            ErrorReportStorage.addDebugData("MainViewCtrl","prepare: _toHotelView is null!");
         }
         this.var_1281.procedure = this.onHotelView;
         ...
         this.var_15.scaler.setParamFlag(HabboWindowParam.const_1820,true);
      }
      ...
      public function refresh() : void
      {
         ...
         Util.moveChildrenToColumn(this.var_184,["custom_content","list_content"],this.var_239.y,8);
         this.var_210.height = this.var_210.height + _loc1_ - this.var_210.y - this.var_275.height + this.var_2811;
         Util.moveChildrenToColumn(this.var_184,["list_content","custom_footer"],this.var_210.y,0);
         this.var_2811 = this.var_275.height;
      ...
      {
         this.refreshList(param1,param2,this.var_1040,"popular_tags");
      }
      
      private function refreshOfficialRooms(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_1280,"official_rooms");
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_678 == const_1065)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_210.blend - _loc2_));
            this.var_210.blend = _loc3_;
            this.var_239.blend = !!this.var_1279 ? Number(_loc3_) : Number(1);
            this.var_275.blend = !!this.var_1279 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_678 = const_682;
            }
         }
         else if(this.var_678 == const_682)
         {
            if(this.var_1568 % 10 == 1)
            {
            ...
            {
               this.var_678 = const_1064;
            }
         }
         else if(this.var_678 == const_1064)
         {
            this.refresh();
            this.var_678 = const_1512;
         }
         else
         {
      ...
      {
         this.refreshScrollbar(this.var_1040);
      ...
      {
         this._navigator.refreshButton(this.var_1281,"icon_hotelview",!param1,null,0);
         this._navigator.refreshButton(this.var_1281,"icon_hotelview_reactive",param1,null,0);
      }
