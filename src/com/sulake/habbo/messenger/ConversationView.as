package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1011:int = 100;
      
      private static const const_1362:int = 20;
       
      
      private var var_137:HabboMessenger;
      
      private var var_2308:IScrollbarWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_137 = param1;
         this.var_1741 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this._list = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2308 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1011 + const_1362)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1363;
         param1.invalidate();
      }
      ...
      public function refreshHeader() : void
      {
         ...
         {
            this.var_1741.enable();
         }
         else
         {
            this.var_1741.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this._list.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_506.messages.length - const_1011);
         _loc1_ = 0;
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_837 || param3.type == Message.const_767 ? param3.time + ": " : "";
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_137.send(new FollowFriendMessageComposer(this.var_506.id));
      }
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_767)
         {
            return 4292801535;
         }
         if(param1 == Message.const_1138)
         {
            return 4294927974;
         }
