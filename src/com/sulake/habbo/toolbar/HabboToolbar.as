package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private var var_1625:LogoutController;
      ...
      private function onConfigurationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1080 = this._config.getKey("client.toolbar.static.enabled","false") == "true";
         this.tryInitialize();
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_1625 = new LogoutController(this,this._windowManager,this._assetLibrary,events,this._config);
         }
         if(this._view == null)
         {
            return;
         }
         events.addEventListener(HabboToolbarSetIconEvent.const_127,this.onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_1254,this.onSetToolbarIconBitmapEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_1309,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_1129,this.onHideWindowEvent);
         this._state = true;
