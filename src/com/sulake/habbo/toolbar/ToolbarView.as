package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView implements IToolbarView
   {
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IEventDispatcher, param6:IHabboConfigurationManager)
      {
         ...
         this.var_224 = param2.createWindow("extrabar_container_window","",HabboWindowType.const_72,HabboWindowStyle.const_1308,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1137 = String(_loc9_.relocate_by_drag.@state) == "true";
         if(this.var_1137)
         {
         ...
         this.var_1138 = _loc9_.toolbar.@margin_top;
         this._toolbarMarginBottom = _loc9_.toolbar.@margin_bottom;
         this._toolbarMinGroupMargin = _loc9_.toolbar.@min_group_margin;
         this.var_1717 = _loc9_.toolbar.@margin_to_extrabar;
         this.var_303 = new ToolbarBarMenuAnimator(param2,this);
         var _loc10_:XMLList = XMLList(_loc9_.toolbar).children();
         var _loc11_:XMLList = XMLList(_loc9_.extras).children();
         this.createGroupsFromXmlList(_loc10_,this.var_251,param2,param3,param4,this._window,this.var_303);
         this.createGroupsFromXmlList(_loc11_,this.var_594,param2,param3,param4,this.var_224,this.var_303);
         this.alignWindows();
      }
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IConnection, param6:IWindowContainer, param7:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc11_ < param1.length())
         {
            ...
            _loc10_ = new ToolbarIconGroup(param3,param4,param5,_loc11_,this._events,param6,param7,this.var_150,this._config);
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_150,this.var_498,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_498);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_150,this.var_498);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_150,this.var_498);
         }
      }
      ...
      {
         this.alignWindows();
         var _loc2_:HabboToolbarEvent = new HabboToolbarEvent(HabboToolbarEvent.const_901);
      ...
      private function alignWindows() : void
      {
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_224.x = this.var_150 + this.var_1717;
               this.var_224.y = 0;
            ...
            case "TOP":
               ...
               this._window.y = 0;
               this.var_224.x = 0;
               this.var_224.y = this.var_150 + this.var_1717;
         ...
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1138;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_251.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this._toolbarMinGroupMargin,(this._window.height - _loc5_ * _loc8_ - this.var_1138 - this._toolbarMarginBottom) / (this.var_251.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this._toolbarMinGroupMargin,(this._window.width - _loc5_ * _loc8_ - this.var_1138 - this._toolbarMarginBottom) / (this.var_251.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_251.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_498;
      ...
      private function onStageMouseMove(param1:MouseEvent) : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_1137 && this.var_1412)
         {
            _loc2_ = this.getTargetOrientationFromXY(param1.stageX,param1.stageY);
            if(_loc2_ != null && _loc2_ != this.var_498)
            {
               this.var_498 = _loc2_;
               this.alignWindows();
               if(this._events != null)
               {
                  _loc3_ = new HabboToolbarEvent(HabboToolbarEvent.const_516);
                  _loc3_.orientation = this.var_498;
