package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarViewStatic implements IToolbarView
   {
      ...
      private static const const_1386:uint = 7433577;
      
      private static const const_1385:uint = 5723213;
      ...
      public function ToolbarViewStatic(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         {
            this.setIconHoverState(_loc11_,const_457);
         }
         ...
         param6.addEventListener(HabboToolbarEvent.const_346,this.onToolbarStateEvent);
         param6.addEventListener(HabboToolbarEvent.const_330,this.onToolbarStateEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this._events)
         {
            this._events.removeEventListener(HabboToolbarEvent.const_346,this.onToolbarStateEvent);
      ...
      private function onToolbarStateEvent(param1:HabboToolbarEvent) : void
      {
         switch(param1.type)
         {
            case HabboToolbarEvent.const_346:
               this.iconVisibility("QUESTS",false);
               this.iconVisibility("MEMENU",false);
               this.iconVisibility("INVENTORY",false);
               break;
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_458 ? this.var_1451 : this.var_1452;
         }
         else
         {
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         ...
         this.var_1452 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1451)
         {
            this.var_1451.dispose();
         }
         this.var_1451 = this.addShadow(param1,new Point(4,5),4281150249);
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindow
      {
         ...
         var _loc2_:IWindowContainer = this.var_1453.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
            ...
            _loc2_.y = const_1022;
            this.var_1453.add(param1,_loc2_);
         }
