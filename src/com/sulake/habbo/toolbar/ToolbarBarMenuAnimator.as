package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1347:Number = 25;
      
      private static const const_1345:Number = 90;
      ...
      private var var_1550:IToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:IToolbarView)
      {
         ...
         this.var_835 = new Timer(const_1347);
         this.var_835.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_394[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_1052 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_1052 || param1.desktop.height - param1.y < const_1469;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1550.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            this.var_394.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Point = this.var_1550.getIconLoc(param1.iconId);
      ...
      {
         return this.var_669[this.var_670.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_670[this.var_669.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(_loc3_ > -1)
         {
            ...
            this.var_669.splice(_loc3_,1);
         }
         this.var_669.push(param1.name);
         this.var_670.push(param2);
         param1.addEventListener(WindowEvent.const_297,this.windowEventListener);
         param1.addEventListener(WindowEvent.const_206,this.windowEventListener);
      }
      ...
      {
         if(this.var_394.indexOf(param1) > -1)
         {
            if(const_235)
            {
            ...
            else
            {
               ...
               this.var_394.splice(this.var_394.indexOf(param1),1);
            }
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(this.var_669[_loc2_] == param1.window.name)
            {
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         var _loc7_:int = 0;
         while(_loc7_ < this.var_394.length)
         {
            _loc2_ = this._itemList[this.var_394[_loc7_]];
            if(_loc2_.active)
            {
