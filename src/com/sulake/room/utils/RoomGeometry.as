package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_968:Number = 64;
      
      public static const const_1169:Number = 32;
      ...
      private var var_416:Number = 1.0;
      
      private var var_417:Number = 1.0;
      
      private var var_418:Number = 1.0;
      ...
      private var var_2971:Number = -500.0;
      
      private var var_2970:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1662 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_415.assign(this.var_90);
         this.var_415.x *= this.var_416;
         this.var_415.y *= this.var_417;
         this.var_415.z *= this.var_418;
         return this.var_415;
      }
      ...
      {
         if(this.var_416 != param1 * this.var_1664)
         {
            this.var_416 = param1 * this.var_1664;
            ++this.var_149;
         }
      }
      ...
      {
         if(this.var_417 != param1 * this.var_1663)
         {
            this.var_417 = param1 * this.var_1663;
            ++this.var_149;
         }
      }
      ...
      {
         if(this.var_418 != param1 * this.var_1662)
         {
            this.var_418 = param1 * this.var_1662;
            ++this.var_149;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_90.x /= this.var_416;
         this.var_90.y /= this.var_417;
         this.var_90.z /= this.var_418;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_419.x;
         var _loc3_:Number = this.var_419.y;
         var _loc4_:Number = this.var_419.z;
         this.var_419.assign(param1);
         this._direction.assign(param1);
         if(this.var_419.x != _loc2_ || this.var_419.y != _loc3_ || this.var_419.z != _loc4_)
         {
            ++this.var_149;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_1111.assign(this.var_166);
         }
         else
         {
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_489 != null)
         {
            ...
            this.var_489.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_489.add(_loc3_,_loc4_);
            ++this.var_149;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_489 != null)
         {
            ...
            return this.var_489.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_416;
         _loc2_.y *= this.var_417;
         _loc2_.z *= this.var_418;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1110);
         if(_loc3_ < this.var_2971 || _loc3_ > this.var_2970)
         {
            return null;
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_90.x * this.var_416,this.var_90.y * this.var_417,this.var_90.z * this.var_418);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_166;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_416,param2.y * this.var_417,param2.z * this.var_418);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_416,param3.y * this.var_417,param3.z * this.var_418);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_416,param4.y * this.var_417,param4.z * this.var_418);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1169;
         }
         else
         {
            this.scale = const_968;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_968;
      }
