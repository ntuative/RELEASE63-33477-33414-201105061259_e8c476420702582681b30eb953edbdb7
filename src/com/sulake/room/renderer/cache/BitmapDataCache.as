package com.sulake.room.renderer.cache
{
   ...
   public class BitmapDataCache
   {
      ...
      public function BitmapDataCache(param1:int, param2:int, param3:int = 1)
      {
         ...
         this.var_973 = param1 * 1024 * 1024;
         this.var_1866 = param2 * 1024 * 1024;
         this.var_1479 = param3 * 1024 * 1024;
         if(this.var_1479 < 0)
         {
            this.var_1479 = 0;
         }
      ...
      {
         this.var_973 += this.var_1479;
         if(this.var_973 > this.var_1866)
         {
            this.var_973 = this.var_1866;
         }
      }
