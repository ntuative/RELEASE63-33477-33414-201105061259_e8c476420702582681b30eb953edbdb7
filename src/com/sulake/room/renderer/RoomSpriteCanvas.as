package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_371:int = 50;
      
      private static const const_1377:int = 50;
      
      private static const const_1017:Number = 60;
      
      private static const const_1376:Number = 50;
      ...
      private var var_255:BitmapDataCache;
      ...
      private var var_1437:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2375:Number = -1.0E7;
      
      private var var_2380:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_256.addChild(this.var_96);
         ...
         this.var_255 = new BitmapDataCache(16,32,1);
         var _loc6_:* = null;
      ...
      {
         this.var_517.x -= param1 - this.var_610;
         this.var_610 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_517.y -= param1 - this.var_611;
         this.var_611 = param1;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_609 != null)
         {
            ...
            {
               this.cleanSprite(this.var_609[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_609 = [];
         }
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_515 != this.var_2379 || this.var_516 != this.var_2378)
         {
            _loc8_ = true;
         }
         if(this.var_96.x != this.var_610 || this.var_96.y != this.var_611)
         {
            this.var_96.x = this.var_610;
            this.var_96.y = this.var_611;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_2379 = this.var_515;
         this.var_2378 = this.var_516;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1436 > 0)
         {
            ...
            {
               ++this.var_762;
               if(this.var_762 == const_371 + 1)
               {
                  this.var_554 = _loc2_;
                  this.var_1779 = this.var_2377;
               }
               else if(this.var_762 > const_371 + 1)
               {
                  _loc3_ = Number(this.var_762 - const_371);
                  this.var_554 = this.var_554 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_1779 = this.var_1779 * (_loc3_ - 1) / _loc3_ + Number(this.var_2377) / _loc3_;
                  if(this.var_762 > const_371 + const_1377)
                  {
                     this.var_762 = const_371;
                     if(!this.var_1167 && this.var_554 > const_1017)
                     {
                        this.var_1167 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1167 && this.var_554 < const_1376)
                     {
                        this.var_1167 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_1780 && this.var_1167);
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_610;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_611;
                  if(this.rectangleVisible(_loc19_,_loc20_,_loc22_.width,_loc22_.height))
                  {
                     ...
                     _loc17_.x = _loc19_ - this.var_610;
                     _loc17_.y = _loc20_ - this.var_611;
      ...
      {
         if(param1 < this.var_515 && param1 + param3 >= 0 && (param2 < this.var_516 && param2 + param4 >= 0))
         {
            if(!this.var_2977)
            {
               return true;
      ...
      private function rectangleVisibleWithExclusion(param1:int, param2:int, param3:int, param4:int) : Boolean
      {
         ...
         if(param1 + param3 >= this.var_515)
         {
            param3 -= this.var_515 + 1 - (param1 + param3);
         }
         if(param2 + param4 >= this.var_516)
         {
            param4 -= this.var_516 + 1 - (param2 + param4);
         }
         for each(_loc5_ in this.var_2381)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_932)
         {
            return null;
         }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         {
            _loc3_ = this.var_609.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
         ...
         if(param2 < 0 || param2 >= this.var_932)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         if(param1 < this.var_763 || this.var_763 == 0)
         {
            _loc4_ = this.var_932 - 1;
            while(_loc4_ >= param1)
            {
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:Boolean, param5:int) : BitmapData
      {
         ...
         if((param3 || param4) && param5 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc6_ = this.var_255.getBitmapData(_loc7_);
            }
            if(_loc6_ == null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_255.addBitmapData(_loc7_,_loc6_);
                  }
                  return _loc6_;
               }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false, param4:Boolean = true, param5:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(name.length > 0)
         {
            finalData = this.var_255.getBitmapData(cacheName);
            if(!allowCreation)
            {
               return finalData;
            }
         ...
         if(finalData == null)
         {
            ...
            this.var_612.identity();
            if(flipH)
            {
               this.var_612.scale(-1,1);
               this.var_612.translate(data.width,0);
            }
            if(flipV)
            {
               this.var_612.scale(1,-1);
               this.var_612.translate(0,data.height);
            }
            finalData.draw(data,this.var_612);
            if(name.length > 0)
            {
               this.var_255.addBitmapData(cacheName,finalData);
            }
         }
         return finalData;
      }
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            {
               finalData = new ExtendedBitmapData(data.width,data.height,true,16777215);
               finalData.copyPixels(data,data.rect,const_675);
            }
            catch(e:Error)
            {
               finalData = new ExtendedBitmapData(1,1,true,16777215);
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_610;
         param2 -= this.var_611;
         this.var_517.x = param1;
         this.var_517.y = param2;
         if(this.var_1168 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1781;
         }
         this.var_1781 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1168;
         return this.var_1781;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_515 / 2;
         var _loc12_:Number = param2 - this.var_516 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1782,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_608.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_608.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2375 || param2 != this.var_2380)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_608.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_608.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
      ...
      {
         if(this.var_362 != null && param1 != null)
         {
            this.var_362.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_362 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = this.var_362.getKey(_loc1_);
            _loc3_ = this.var_362.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1437.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1168 == 0)
         {
            this.checkMouseHits(this.var_517.x,this.var_517.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1168 = 0;
         ++this.var_1782;
      }
